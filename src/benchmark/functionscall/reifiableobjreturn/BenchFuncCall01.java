 ...
 *
 */
public class BenchFuncCall01 extends FunctionCall {
    public BenchFuncCall01() {
    }

    public BenchFuncCall01(NodeImpl node) {
        super(node, "Functions Call --> ReifiableObject f()",
            "Mesure the time of a call Function who return ReifiableObject with no argument.");
    }
    ...
    public ReifiableObject f() throws Exception {
