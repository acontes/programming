...
public class BenchFuncCall08 extends FunctionCall {
    ...
    public BenchFuncCall08(NodeImpl node) {
        super(node, "Functions Call  --> ReifiableObject f(ReifiableObject)",
            "Mesure the time of a call Function who return ReifiableObject with 1 ReifiableObject argument.");
    }
    ...
    public ReifiableObject f(ReifiableObject o) throws Exception {
        o.toString();
