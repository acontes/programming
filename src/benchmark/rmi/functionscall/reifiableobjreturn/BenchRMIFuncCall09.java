...
public class BenchRMIFuncCall09 extends RMIFunctionCall {
    ...
    public BenchRMIFuncCall09(NodeImpl node) {
        super(node,
            "RMI Functions Call  --> ReifiableObject f(ReifiableObject, ReifiableObject)",
            "Mesure the time of a call Function who return ReifiableObject with 2 ReifiableObject arguments.");
    }
