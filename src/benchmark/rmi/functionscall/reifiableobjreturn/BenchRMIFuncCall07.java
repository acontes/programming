 ...
 *
 */
public class BenchRMIFuncCall07 extends RMIFunctionCall {
    public BenchRMIFuncCall07() {
    }

    public BenchRMIFuncCall07(NodeImpl node) {
        super(node,
            "RMI Functions Call  --> ReifiableObject f(String, String, String)",
            "Mesure the time of a call Function who return ReifiableObject with 3 String arguments.");
    }

    public long action() throws Exception {
        BenchRMIFuncCall07 activeObject = (BenchRMIFuncCall07) getRmiObject();
        String s = "toto";
        String t = "tutu";
        String u = "titi";
        this.timer.start();
    ...
    public ReifiableObject f(String s, String t, String u)
        throws Exception {
        s.toString();
        t.toString();
        u.toString();
