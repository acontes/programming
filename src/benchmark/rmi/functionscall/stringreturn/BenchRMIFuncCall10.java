...
public class BenchRMIFuncCall10 extends RMIFunctionCall {
    ...
    public BenchRMIFuncCall10(NodeImpl node) {
        super(node,
            "RMI Functions Call  --> String f(ReifiableObject, ReifiableObject, ReifiableObject)",
            "Mesure the time of a call Function who return String with 3 ReifiableObject arguments.");
    }
