...
public class BenchRMIFuncCall08 extends RMIFunctionCall {
    ...
    public BenchRMIFuncCall08(NodeImpl node) {
        super(node, "RMI Functions Call  --> String f(ReifiableObject)",
            "Mesure the time of a call Function who return String with 1 ReifiableObject argument.");
    }
    ...
    public String f(ReifiableObject o) throws Exception {
        o.toString();
