...
public class BenchRMIFuncCall06 extends RMIFunctionCall {
    ...
    public BenchRMIFuncCall06(NodeImpl node) {
        super(node, "RMI Functions Call  --> String f(String, String)",
            "Mesure the time of a call Function who return String with 2 String arguments.");
    }
    ...
    public String f(String s, String t) throws Exception {
        s.toString();
        t.toString();
