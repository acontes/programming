...
public class BenchRMIFuncCall10 extends RMIFunctionCall {
    ...
    public BenchRMIFuncCall10(NodeImpl node) {
        super(node,
            "RMI Functions Call  --> void f(ReifiableObject, ReifiableObject, ReifiableObject)",
            "Mesure the time of a call Function who return void with 3 ReifiableObject arguments.");
    }
    ...
    public void f(ReifiableObject o, ReifiableObject p, ReifiableObject q)
        throws Exception {
        o.toString();
        p.toString();
        q.toString();
