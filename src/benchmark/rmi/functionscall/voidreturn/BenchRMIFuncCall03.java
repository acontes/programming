...
public class BenchRMIFuncCall03 extends RMIFunctionCall {
    ...
    public BenchRMIFuncCall03(NodeImpl node) {
        super(node, "RMI Functions Call  --> void f(int, int)",
            "Mesure the time of a call Function who return void with 2 int arguments.");
    }
    ...
    public void f(int i, int j) throws Exception {
        i++;
        j++;
