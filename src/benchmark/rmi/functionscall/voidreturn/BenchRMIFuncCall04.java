...
public class BenchRMIFuncCall04 extends RMIFunctionCall {
    ...
    public BenchRMIFuncCall04(NodeImpl node) {
        super(node, "RMI Functions Call  --> void f(int, int, int)",
            "Mesure the time of a call Function who return void with 3 int arguments.");
    }
    ...
    public void f(int i, int j, int k) throws Exception {
        i++;
        j++;
        k++;
