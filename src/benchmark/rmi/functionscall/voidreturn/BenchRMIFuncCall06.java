...
public class BenchRMIFuncCall06 extends RMIFunctionCall {
    ...
    public BenchRMIFuncCall06(NodeImpl node) {
        super(node, "RMI Functions Call  --> void f(String, String)",
            "Mesure the time of a call Function who return void with 2 String arguments.");
    }
    ...
    public void f(String s, String t) throws Exception {
        s.toString();
        t.toString();
