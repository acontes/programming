			...
			getContentPane().setLayout(thisLayout);
			{
				...
				pnlTaskWait.setBorder(BorderFactory.createTitledBorder("Pending Tasks"));
				{
								...
								g.drawImage(Toolkit.getDefaultToolkit()
									.getImage(
										getClass().getResource(
											"img/runTask.gif")), 0, 0, this);
							}
						};
						pnlLegendWait.add(pnlIconWait);
						pnlIconWait.setPreferredSize(new java.awt.Dimension(
							100,
							28));
					...
					}
					{
						...
						lblLegendWait.setPreferredSize(new java.awt.Dimension(
							100,
							28));
			...
			}
			{
				...
				pnlTaskRun.setSize(100, 28);
				{
					...
					pnlTaskRun.add(pnlLegendRun);
					{
						...
						pnlIconRun.setPreferredSize(new java.awt.Dimension(
							100,
							28));
					...
					}
					{
						...
						lblLegendRun.setPreferredSize(new java.awt.Dimension(
							100,
							28));
			...
			}
			{
				...
				pnlTaskEnd.setBorder(BorderFactory.createTitledBorder("Terminated Tasks"));
				{
					...
					pnlTaskEnd.add(pnlLegendEnd);
					{
						...
						pnlIconSuccess.setPreferredSize(new java.awt.Dimension(
							100,
							28));
