...
public class PeerSetupGUI {
    ...
    public Component createComponents() {
        ...
        JLabel tableLabel = new JLabel(
                "Add or Remove authorized intervals for participation in the P2P System");
        ...
        buttonA.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    JFrame frame = new JFrame(
                            "ProActive daemon configuration panel -> Adding one record");
                    RowModification mPanel = new RowModification(frame,
                            getThis, rows);
        ...
        buttonM.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    JFrame frame = new JFrame(
                            "ProActive daemon configuration panel -> Modifing one record");
                    RowModification mPanel = new RowModification(frame,
                            getThis, table.getSelectedRow());
                    frame.setResizable(false);
                    Component contents = mPanel.createComponents();
                    frame.getContentPane().add(contents, BorderLayout.CENTER);
                    frame.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
        ...
        buttonS.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    for (int k = 0; k <= rows; k++) {
                        ...
                        int startTime = (Integer.parseInt(auxArray[0]) * 100) +
                            Integer.parseInt(auxArray[1]);

                        // Finish time
                        aux = (String) grid[k][2];
                        auxArray = aux.split(":");
                        int stopTime = (Integer.parseInt(auxArray[0]) * 100) +
                            Integer.parseInt(auxArray[1]);
                        ...
                        if (stopTime > startTime) {
                            ...
                            workTime = (startTime + 2400) - stopTime;
                        }
                        ...
                        schedule[k].setDays(schedule[k].Days2Byte(
                                (String) grid[k][0]));
                        ...
                        if ("Permanent".equals(aux)) {
                            ...
                            GregorianCalendar begin = new GregorianCalendar(year,
                                    month, day);

                            day = Integer.parseInt(endDate[0]);
                            month = Integer.parseInt(endDate[1]) - 1;
                            year = Integer.parseInt(endDate[2]);
                            GregorianCalendar end = new GregorianCalendar(year,
                                    month, day);
