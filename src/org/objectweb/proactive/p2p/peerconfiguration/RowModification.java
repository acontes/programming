...
public class RowModification {
    ...
    public Component createComponents() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (!(mondayCheck.isSelected()) &&
                        ...
                        JOptionPane.showConfirmDialog(frame,
                            "Please select at least one day", "Input error",
                    ...
                    if (!(permanentCheck.isSelected())) {
                        ...
                        if (!(checkDate(0, 0, appInt1.intValue(),
                                    appInt2.intValue(), appInt3.intValue(), 0)) ||
                                !(checkDate(0, 0, appInt4.intValue(),
                                    appInt5.intValue(), appInt6.intValue(), 0))) {
                            JOptionPane.showConfirmDialog(frame,
                        ...
                        GregorianCalendar stopGC = new GregorianCalendar(appInt3.intValue(),
                                appInt2.intValue(), appInt1.intValue());
                        GregorianCalendar startGC = new GregorianCalendar(appInt6.intValue(),
                                appInt5.intValue(), appInt4.intValue());
                    ...
                    if (permanentCheck.isSelected()) {
                        ...
                        validity = validity + appInt4.intValue() + "/" +
                            appInt5.intValue() + "/" + appInt6.intValue() +
                            " - ";
                        validity = validity + appInt1.intValue() + "/" +
                            appInt2.intValue() + "/" + appInt3.intValue();
                    }
                     ...
                     */
                    String start = startHour.intValue() + ":" +
                        startMinutes.intValue();
                    String stop = stopHour.intValue() + ":" +
                        stopMinutes.intValue();
        ...
        intermediatePanel.setLayout(new BoxLayout(intermediatePanel,
                BoxLayout.Y_AXIS));
        ...
        spinnerStartHour = SpinnerSet.addLabeledSpinner(bTimePanel, "H",
                hourStartModel);
        SpinnerModel minutesStartModel = new CyclingSpinnerListModel(minutes);
        spinnerStartMinutes = SpinnerSet.addLabeledSpinner(bTimePanel, "M",
                minutesStartModel);
        ...
        spinnerStopHour = SpinnerSet.addLabeledSpinner(fTimePanel, "H",
                hourStopModel);
        SpinnerModel minutesStopModel = new CyclingSpinnerListModel(minutes);
        spinnerStopMinutes = SpinnerSet.addLabeledSpinner(fTimePanel, "M",
                minutesStopModel);
        ...
        SliderValueUpdate cListener = new SliderValueUpdate(slider,
                currentValueTXT);
        ...
        editingPanel.setBorder(BorderFactory.createEmptyBorder(30, 30, 10, 30));
