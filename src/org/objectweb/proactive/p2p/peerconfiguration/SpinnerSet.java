...
public class SpinnerSet extends JPanel {
    ...
    public SpinnerSet(boolean cycleMonths) {
        ...
        spinnerMonth = addLabeledSpinner(this, labels[1], monthModel);
    ...
    public int getMonth() {
        ...
        if (monthString.compareTo("January") == 0) {
            return (1);
        }
        if (monthString.compareTo("February") == 0) {
            return (2);
        }
        if (monthString.compareTo("March") == 0) {
            return (3);
        }
        if (monthString.compareTo("April") == 0) {
            return (4);
        }
        if (monthString.compareTo("May") == 0) {
            return (5);
        }
        if (monthString.compareTo("June") == 0) {
            return (6);
        }
        if (monthString.compareTo("July") == 0) {
            return (7);
        }
        if (monthString.compareTo("August") == 0) {
            return (8);
        }
        if (monthString.compareTo("September") == 0) {
            return (9);
        }
        if (monthString.compareTo("October") == 0) {
            return (10);
        }
        if (monthString.compareTo("November") == 0) {
            return (11);
        }
        if (monthString.compareTo("December") == 0) {
            return (12);
        }
        return (1);
    }
