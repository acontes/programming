...
public class P2PRegistryImpl implements Serializable, P2PRegistry, RunActive {
    ...
    public P2PRegistryImpl() throws ProActiveException {
    ...
    public static void main(String[] args) throws Exception {
        P2PRegistryImpl Areg = (P2PRegistryImpl) ProActive.newActive(P2PRegistryImpl.class.getName(),
                new Object[] {  });
