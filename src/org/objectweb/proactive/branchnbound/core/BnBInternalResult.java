 ...
 */
public class BnBInternalResult<Value extends Comparable<Value>> implements Comparable<BnBInternalResult>,
    Serializable {
     ...
     */
    public BnBInternalResult(Value value) {
     ...
     */
    public BnBInternalResult(Throwable exception) {
