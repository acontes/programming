 ...
 *
 */
public class ComponentRequestQueueImpl extends BlockingRequestQueueImpl
    ...
    public synchronized Request blockingRemoveOldest() {
        ...
        if (req instanceof ComponentRequest) {
            if (req.getMethodCall().getReifiedMethod().getDeclaringClass()
                       .equals(LifeCycleController.class)) {
    ...
    private class RequestFilterOnComponentControllerClasses
