 ...
 */
public class ComponentsDescriptorHandler extends AbstractUnmarshallerDecorator
    ...
    public ComponentsDescriptorHandler(ProActiveDescriptor deploymentDescriptor) {
        ...
        addHandler(COMPONENTS_TAG,
            new ComponentsHandler(deploymentDescriptor, componentsCache,
                componentTypes, null));
    ...
    String componentsDescriptorURL, String deploymentDescriptorURL)
        ...
        try {
            ...
            logger.info("loading deployment description from file : " +
    ...
    public static ComponentsDescriptorHandler createComponentsDescriptorHandler(
        String componentsDescriptorURL, ProActiveDescriptor deploymentDescriptor)
        throws IOException, SAXException, ProActiveException {
        try {
            InitialHandler initial_handler = new InitialHandler(deploymentDescriptor);
            String uri = componentsDescriptorURL;
    ...
    private static class InitialHandler extends AbstractUnmarshallerDecorator {
        ...
        private InitialHandler(ProActiveDescriptor deploymentDescriptor) {
            ...
            this.addHandler(COMPONENTS_DESCRIPTOR_TAG,
    ...
    public static void main(String[] args) {
        ...
        logger.info("loading deployment description from file : " +
            deploymentDescriptorFileLocation);
        ...
        logger.info("loading component description from file : " +
            componentsDescriptorFileLocation);
        try {
            createComponentsDescriptorHandler(componentsDescriptorFileLocation,
