 ...
 *
 */
public class ReceiveRequestCommunicationException
    extends ReceiveCommunicationException {

    /**
     * Constructs a <code>ReceiveRequestCommunicationException</code> with the specified
