...
public class RemoteXMLBodyFactory extends ProActiveMetaObjectFactory
    implements java.io.Serializable {
    //
    // -- PROTECTED MEMBERS -----------------------------------------------
    //
    protected RemoteBodyFactory newRemoteBodyFactorySingleton() {
        return new RemoteXMLBodyFactoryImpl();
    }

    //
    // -- INNER CLASSES -----------------------------------------------
    //
    protected static class RemoteXMLBodyFactoryImpl implements RemoteBodyFactory,
