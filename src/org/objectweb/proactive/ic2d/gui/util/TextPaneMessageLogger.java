...
public class TextPaneMessageLogger implements IC2DMessageLogger {
    ...
    public TextPaneMessageLogger(javax.swing.JTextPane messageArea) {
        ...
        javax.swing.text.StyleConstants.setForeground(stackTraceStyle,
            java.awt.Color.lightGray);
        // threadName Style
        threadNameStyle = messageArea.addStyle("threadName", regularStyle);
        javax.swing.text.StyleConstants.setForeground(threadNameStyle,
        ...
        javax.swing.text.StyleConstants.setForeground(timeStampStyle,
            java.awt.Color.blue);
    ...
    private void logInternal(final String message,
        final javax.swing.text.AttributeSet style) {
