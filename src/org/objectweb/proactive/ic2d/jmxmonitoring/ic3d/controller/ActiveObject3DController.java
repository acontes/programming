...
public class ActiveObject3DController extends AbstractActiveObject3DController {
    ...
    protected AbstractFigure3DController createChildController(
        AbstractData figure) {
        System.out.println(
            "No children have been implemented for ActiveObjects");
        return null;
    }
    ...
    public void update(Observable o, Object arg) {
        ...
        case STATE_CHANGED: {
            // new Thread() {
            // public void run() {
            ((ActiveObject3D) getFigure()).setState((org.objectweb.proactive.ic2d.jmxmonitoring.util.State) notif.getData());
            // }
            // }.start();
            break;
        }
        case ACTIVE_OBJECT_ADD_COMMUNICATION: {
            ...
            AbstractFigure3DController srcController = AbstractFigure3DController.registry.get(aoSource);
            ...
            Grid3DController rootGridController = (Grid3DController) ActiveObject3DController.this.getParent()
                                                                                                  .getParent()
                                                                                                  .getParent()
                                                                                                  .getParent();
            ...
            rootGrid.drawArrow(aoSource.getKey() +
                new Double(Math.random()).toString(), "noName", 100, source3d,
                dest3d);
            // }
            // }).start();
            // else
