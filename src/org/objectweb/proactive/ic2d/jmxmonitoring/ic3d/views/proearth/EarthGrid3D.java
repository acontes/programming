...
/**
 * An implementation of a grid figure. It uses a
 * Earth texture and places the hosts on a sphere.
 * The arrows used to show communications are curved.
 * <br/>
 * WORK IN PROGRESS
 * 
 * @author vasile
...
public class EarthGrid3D extends AbstractGrid3D {
	...
	public void arrangeSubFigures() {
        ...
        for (AbstractFigure3D host : this.getSubFigures().values()) {
            PlacementBasket.sphereArrangement(Math.random()*4*Math.PI,
            			Math.random()*4*Math.PI, host);
