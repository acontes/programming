...
public class GeometryBasket {
        ...
        //TODO does not work
        public static Geometry sphereArrowGeometry(Tuple2d ao1, Tuple2d ao2,
        ...
        The three coordinates (radius,alpha, beta) are defined as:
                ...
                System.out.println("ao1.x :"+ ao1.x
                                + " ao1.y :"+ ao1.y+
                                " ao2.x :"+ ao2.x+
                                " ao2.y :"+ ao2.y );
...
//              normGen.setCreaseAngle((float) Math.toRadians(90));
        ...
        private static Geometry activeObjectGeometry() {
                Sphere s = new Sphere(1,
                                Primitive.GENERATE_NORMALS | Primitive.GENERATE_TEXTURE_COORDS, 25);
        ...
        private static Geometry earthGridGeometry() {
                Sphere s = new Sphere(15,
                                Primitive.GENERATE_NORMALS | Primitive.GENERATE_TEXTURE_COORDS, 150);
                return s.getShape().getGeometry();
        }
        //------------- PUBLIC METHODS ----------------
