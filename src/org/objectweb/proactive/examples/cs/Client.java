...
public class Client {
    ...
    public void doStuff() {
        ...
        // theServer.setMessageOfTheDay(this.myName + " is connected (" + dateFormat.format(new java.util.Date()) + ")");
        System.out.println("message on the server =  " +
            theServer.getMessageOfTheDay());
    }
