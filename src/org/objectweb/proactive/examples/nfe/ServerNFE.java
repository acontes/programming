...
public class ServerNFE {
     ...
     */
    protected void raiseException(Class classOfException)
        throws NonFunctionalException {
        ...
        try {
            ex = (NonFunctionalException) classOfException.getConstructor(new Class[] {
                        String.class, Throwable.class
                    }).newInstance(new Object[] { classOfException.getName(), null });
        } catch (Exception e) {
    ...
    public void test(String args) {
        ...
        try {
            ex = (NonFunctionalException) Class.forName(args)
                                               .getConstructor(new Class[] {
                        String.class, Throwable.class
                    }).newInstance(new Object[] { args, null });
        } catch (ClassNotFoundException e) {
            if (logger.isDebugEnabled()) {
                logger.debug("*** ERROR => Class " + args +
                    " is not a valid NFE");
            }
            System.exit(0);
            ...
            if (logger.isDebugEnabled()) {
                logger.debug(
                    "*** ERROR => A problem occurs during instantiation " +
                    args);
            }
            e.printStackTrace();
            System.exit(0);
        ...
        System.out.println("PARAMETER => " + ex.getDescription() +
            ex.getMessage() + "\n");
        ...
        ProActive.setExceptionHandler(HandlerMigrationException.class,
            ProActiveMigrationException.class, Handler.ID_Body, this);
        ProActive.unsetExceptionHandler(ProActiveCommunicationException.class,
            Handler.ID_Body, this);
        ...
        try {
            ...
            if (handler != null) {
                ...
                System.out.println("EXCEPTION CATCHED BY => " +
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ServerNFE server = (ServerNFE) org.objectweb.proactive.ProActive.newActive(ServerNFE.class.getName(),
                    null);
            java.net.InetAddress localhost = java.net.InetAddress.getLocalHost();
            org.objectweb.proactive.ProActive.register(server,
                "//" + localhost.getHostName() + "/Server");
        } catch (Exception e) {
