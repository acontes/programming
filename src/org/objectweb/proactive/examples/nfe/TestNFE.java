...
public class TestNFE {
     ...
     */
    public void raiseException(Class classOfException)
        throws NonFunctionalException {
    ...
    public void go(String[] args) {
        ...
        if (args.length != 1) {
            System.out.println(
                "USAGE =>  java org.objectweb.proactive.examples.nfeCreation NFE");
            System.exit(0);
        }
        ...
        try {
            ex = (NonFunctionalException) Class.forName(args[0])
                                               .getConstructor(new Class[] {
                        String.class, Throwable.class
                    }).newInstance(new Object[] { args[0], null });
        } catch (ClassNotFoundException e) {
            if (logger.isDebugEnabled()) {
                logger.debug("*** ERROR => Class " + args[0] +
                    " is not a valid NFE");
            }
            System.exit(0);
        ...
        ProActive.setExceptionHandler(HandlerCommunicationException.class,
            ProActiveCommunicationException.class, Handler.ID_VM, null);
