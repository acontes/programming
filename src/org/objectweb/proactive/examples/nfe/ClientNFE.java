    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (args.length == 0) {
                ...
                server = (ServerNFE) org.objectweb.proactive.ProActive.newActive(ServerNFE.class.getName(),
                        null);
            } else {
                // Lookups the server object
                System.out.println("Using server located on " + args[0]);
                server = (ServerNFE) org.objectweb.proactive.ProActive.lookupActive(ServerNFE.class.getName(),
                        args[0]);
            }
            ...
            ProActive.setExceptionHandler(HandlerCommunicationException.class,
                ProActiveCommunicationException.class, Handler.ID_Body, server);
