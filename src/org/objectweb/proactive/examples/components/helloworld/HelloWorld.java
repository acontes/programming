...
public class HelloWorld {
    private static String LOCAL_COMPONENTS_DESCRIPTOR = HelloWorld.class.getResource(
            "/org/objectweb/proactive/examples/components/helloworld/helloworld-local.xml")
                                                                        .getPath();
    private static String DISTRIBUTED_COMPONENTS_DESCRIPTOR = HelloWorld.class.getResource(
            "/org/objectweb/proactive/examples/components/helloworld/helloworld-distributed.xml")
                                                                              .getPath();
    private static String DEPLOYMENT_DESCRIPTOR = HelloWorld.class.getResource(
    ...
    public static void main(final String[] args) throws Exception {
        ...
        if (useParser) {
            ...
            if (distributed) {
                loader.loadComponentsConfiguration(DISTRIBUTED_COMPONENTS_DESCRIPTOR,
                    DEPLOYMENT_DESCRIPTOR);
            } else {
                loader.loadComponentsConfiguration(LOCAL_COMPONENTS_DESCRIPTOR,
                    DEPLOYMENT_DESCRIPTOR);
            }
            ...
            ComponentType rType = tf.createFcType(new InterfaceType[] {
                        tf.createFcItfType("m", Main.class.getName(), false,
                            false, false)
                    });
            ...
            ComponentType sType = tf.createFcType(new InterfaceType[] {
                        ...
                        tf.createFcItfType("attribute-controller",
                            ServiceAttributes.class.getName(), false, false,
                            false)
                    });
            ...
            if (!useTemplates) {
                ...
                rComp = cf.newFcInstance(rType,
                        new ControllerDescription("root", Constants.COMPOSITE),
                        null);
