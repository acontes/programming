...
public class ComputeRandom {
	 ...
	 */
	public static void main(String[] args) throws FileNotFoundException, IOException, VirtualServiceException, ProActiveException, InterruptedException {
		...
		if( PAProperties.PA_COMMUNICATION_PROTOCOL.getValue().equals("pamr")){
			...
			if(!address.isSet()){
				...
				System.out.println("address was not set, now it is: " + ProActiveInet.getInstance().getInetAddress());
			}else{
