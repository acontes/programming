...
public class ActiveDisplay implements ConsumerProducerListener {
    ...
    public void start() {
        ...
        Object o = org.objectweb.proactive.ProActive.getStubOnThis();

        // Active Buffer creation
        try {
            buffer = (BoundedBuffer) org.objectweb.proactive.ProActive.newActive(BoundedBuffer.class.getName(),
        ...
        try {
            producer = (Producer) org.objectweb.proactive.ProActive.newActive(Producer.class.getName(),
                    new Object[] { o, buffer });
        } catch (Exception e) {
        }
        ...
        try {
            consumer = (Consumer) org.objectweb.proactive.ProActive.newActive(Consumer.class.getName(),
                    new Object[] { o, buffer });
        } catch (Exception e) {
        }
