...
public class GeneralResultImpl implements GeneralResult {
    ...
    /* (non-Javadoc)
     * @see org.objectweb.proactive.examples.scilab.GeneralResult#getState()
     */
    public int getState() {
        return state;
    }
    ...
    /* (non-Javadoc)
     * @see org.objectweb.proactive.examples.scilab.GeneralResult#setState(int)
     */
    ...
    /* (non-Javadoc)
     * @see org.objectweb.proactive.examples.scilab.GeneralResult#getTimeExecution()
     */
    ...
    /* (non-Javadoc)
     * @see org.objectweb.proactive.examples.scilab.GeneralResult#setTimeExecution(long)
     */
    ...
    /* (non-Javadoc)
     * @see org.objectweb.proactive.examples.scilab.GeneralResult#getId()
     */
    public String getId() {
        return id;
    }
