...
public class DataSpacesInstaller implements Serializable {
     ...
     */
    public ObjectForSynchro startDataSpaces(long appId,
            BaseScratchSpaceConfiguration baseScratchConfiguration, String namingServiceURL)
            throws FileSystemException, ProActiveException, URISyntaxException {
        logger.info(getNameForLoggers() + " starts data spaces");

        this.appId = appId;
        this.node = Utils.getCurrentNode();
