 ...
 * ################################################################
 */
package nonregressiontest.component.binding.remote.parallel;
...
public class Test extends ComponentTest {
    ...
    public Test() {
        super("Binding of parallel components on remote nodes",
            "Binding of parallel components on remote nodes");
    }
