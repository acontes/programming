...
public class TestPerformancesNIO {

    final static public byte buf[] = new byte[10 * 1024 * 1024]; // 1Mo
    private static Router reg;
    ...
    @BeforeClass
    public static void init() throws IOException, ProActiveException, InterruptedException {
        reg = new Router(10011, true);

        PAProperties.PA_NET_ROUTER_PORT.setValue(10011);

        Thread.sleep(2000);
        
        System.out.println("Registry started on port " + 10011 + ".");
    ...
    public static void cleanup() {
        //reg.stop();
        System.out.println("Registry on port " + 10011 + " stopped.");
    }
