...
// TODO: This version of Message.java is the one using Endpoints. It should be completed if necessary.
 ...
 * 
 */
public class MessageEndpointVersion {
    ...
    public static final int REGISTRATION_REQUEST = 0; // Registration request to the registry
    public static final int REGISTRATION_REPLY = 1; // Registration reply from the registry indicating the attributed localid
    public static final int CONNECTION_REQUEST = 2; // Connection request from a client to a server
    public static final int CONNECTION_ACCEPTED = 3; // response to a connection request
    public static final int CONNECTION_ABORTED = 4; // response to a connection request
    public static final int AGENT_DISCONNECTED = 5; // help closing properly the connections
    public static final int DATA = 6; // data message
    ...
    MessageEndpointVersion(int type, AgentID srcAgentID, AgentID dstAgentID, EndpointID srcEndpointID,
            EndpointID dstEndpointID, long msgID, byte[] data) {
        this.type = type;
    ...
    public static MessageEndpointVersion registrationRequestMessage() {
        return new MessageEndpointVersion(REGISTRATION_REQUEST, null, null, null, null, 0, null);
    }

    public static MessageEndpointVersion registrationRequestReply(AgentID dstAgentID) {
        return new MessageEndpointVersion(REGISTRATION_REPLY, null, dstAgentID, null, null, 0, null);
    }
     ...
     */
    MessageEndpointVersion(byte[] byteArray, int offset) {
