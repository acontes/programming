...
public class InfrastructureManagerProxy implements InitActive, RunActive {
    ...
    public static InfrastructureManagerProxy getProxy(URI uriIM)
        ...
        return (InfrastructureManagerProxy) ProActive.newActive(InfrastructureManagerProxy.class.getCanonicalName(),
    ...
    private void verify() {
        ...
        while (iterator.hasNext()) {
            ...
            if (!ProActive.isAwaited(entry.getValue())) { // !awaited = arrived
                if (logger.isInfoEnabled()) {
