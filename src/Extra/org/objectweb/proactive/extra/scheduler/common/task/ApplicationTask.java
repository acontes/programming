...
public class ApplicationTask extends Task {
	...
	public void addDependence(Task task){
		throw new RuntimeException("ApplicationTask.addDependence(Task) Should be never used in this context !");
	}
	...
	public void addDependences (List<Task> tasks) {
		throw new RuntimeException("ApplicationTask.addDependences(List<Task>) Should be never used in this context !");
	}
	...
	public void setNumberOfNodesNeeded(int numberOfNodesNeeded) {
		if (numberOfNodesNeeded < 1) numberOfNodesNeeded = 1;
