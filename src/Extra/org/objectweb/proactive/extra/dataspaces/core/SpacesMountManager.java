...
public interface SpacesMountManager {
     ...
     */
    public abstract DataSpacesFileObject resolveFile(final DataSpacesURI queryUri,
            final String ownerActiveObjectId) throws FileSystemException, SpaceNotFoundException;
