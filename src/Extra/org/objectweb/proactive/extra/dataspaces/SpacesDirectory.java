...
/**
 * Stores mappings to SpaceInstanceInfos from DataSpacesURI and provides methods for registering and
 * lookup. The most common lookups are:
 * <ul>
...
public interface SpacesDirectory {
    ...
    /**
     * Lookup for space instance info with given mounting point URI (must be complete).
     * 
     * @param uri
     ...
     * <code>ls -R</code> like). Subsequent method calls may return different result - the same or
     * with new elements.
     * 
     * @param uri
     *            root URI to look up
     ...
     *            - space instance info to register (contract: SpaceInstanceInfo mounting point
     *            should be complete)
