...
/**
 * Represents immutable Data Spaces node-specific configuration. Also produces and manages
 * application-specific configuration - {@link NodeApplicationConfigurator}, indirectly Data Spaces
 ...
 * node. This involves creation and configuration of {@link NodeApplicationConfigurator}.</li>
 ...
 * </ol>
 * <p>
 * Instances of this class are thread-safe. Instances of this class may be managed by
 * {@link DataSpacesNodes} static class.
 * 
...
public class NodeConfigurator {
     ...
     *            base scratch data space configuration, may be null if node does not provide
     *            scratch
     * @param node
     *            node to configure
     ...
     * <p>
     * If configuration fails any subsequent {@link #getDataSpaceImpl()} call will throw
     * {@link NotConfiguredException} until successful configuration.
     * 
     * @param appid
     *            application id
     ...
     * node configuration-specific objects may be undefined.
     */
