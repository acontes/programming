...
/**
 * Maintains Data Spaces application-specific node configuration and its life cycle, producing Data
 * Spaces implementation, {@link DataSpacesImpl}.
 * <p>
 ...
 * <li>
 * {@link #configureApplication(long, String, DefaultFileSystemManager, NodeScratchSpace)} method
 * call for passing application specific settings. This can be called only once.</li>
 * <li>Obtaining {@link DataSpacesImpl} when needed.</li>
 * <li>Closing all opened resources by calling {@link #close()} method.</li>
 * </ol>
 * <p>
 * Instances of this class are thread-safe. This class is intended to be created and managed by
 * higher-level {@link NodeConfigurator}.
 * 
...
public class NodeApplicationConfigurator {
    ...
    /**
     * Configures node for application, resulting in creation of configured {@link DataSpacesImpl}.
     ...
     *            configured node scratch space, may be null if there is no scratch space configured
     *            for this node
     ...
     * @throws ProActiveException
     *             on communication error while accessing NamingService or configuration-related
     *             exceptions
     */
     ...
     * <p>
     * More than one call of this method may result in undefined behavior. Further calls of
     * application configuration-related objects may be undefined.
     * 
