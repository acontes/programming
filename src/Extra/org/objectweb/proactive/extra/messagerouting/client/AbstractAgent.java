...
/**
 * Refactoring the pamr implementation.
 * This class gathers common operations for {@link Agent} implementations.
 * @author fabratu
 * @version %G%, %I%
 * @since ProActive 4.10
 */
public abstract class AbstractAgent implements Agent, AbstractAgentMBean {

    public static final Logger logger = ProActiveLogger.getLogger(Loggers.FORWARDING_CLIENT);

    /** Address of the router */
    final protected InetAddress routerAddr;
    /** Port of the router */
    final protected int routerPort;
    /** Local AgentID, set after initialization. **/
    protected AgentID agentID = null;
    /** Request ID Generator **/
    protected final AtomicLong requestIDGenerator;

    /** Senders waiting for a response */
    final private WaitingRoom mailboxes;

    /** Current tunnel, can be null */
    protected Tunnel t = null;
     ...
     */
    protected AbstractAgent(InetAddress routerAddr, int routerPort,
     ...
     */
    synchronized protected Tunnel getTunnel() {
        if (this.t != null)
            return this.t;
    ...
    /**
     * Create a pamr {@link Tunnel} for communication with the router.
     * AbstractAgent implementations are responsible of actually creating the tunnel
     * @return the current tunnel
     * @throws IOException - the tunnel cannot be opened
     */
    protected abstract Tunnel createTunnel() throws IOException;
    ...
    class MessageReader implements Runnable {
        ...
        public MessageReader(AbstractAgent agent) {
            this.agent = agent;
        }
    ...
    /**
     * Registers the MBean with the platform MBeanServer.
     * This operation is implementation-dependent. 
     * Particularly, the agent MBean name needs to be different  
     */
