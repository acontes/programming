...
/**
 * MBean for the Router implementation
 * @author fabratu
 * @version %G%, %I%
 * @since ProActive 4.10
 */
public interface RouterImplMBean {

    // get all the clients which are registered to this router
    public String[] getRegisteredAgents();

    // indicates if the given registered Agent supports
