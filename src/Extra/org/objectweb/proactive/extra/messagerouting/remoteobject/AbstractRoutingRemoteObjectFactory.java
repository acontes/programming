...
/**
 * Refactoring - abstract away pamr rof ops
 * @author fabratu
 * @version %G%, %I%
 * @since ProActive 4.10
 */
public abstract class AbstractRoutingRemoteObjectFactory extends AbstractRemoteObjectFactory implements
        RemoteObjectFactory {
    ...
    public AbstractRoutingRemoteObjectFactory() {
        ...
        this.agent = agentInit(routerAddress, routerPort);

        this.registry = MessageRoutingRegistry.singleton;
    }

    /**
     * Concrete implementations will provide the Agent 
     */
    protected abstract Agent agentInit(InetAddress routerAddress, int routerPort);

    protected void logAndThrowException(String message) {
    ...
    protected void logAndThrowException(String message, Exception e) {
        ProActiveRuntimeException exception;
