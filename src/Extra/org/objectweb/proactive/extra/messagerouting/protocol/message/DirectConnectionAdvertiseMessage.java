...
/** A {@link MessageType#DIRECT_CONNECTION_ADVERTISE} message.
 *
 * Sent by the client to the router to inform that
 * 	it can accept direct connections from other agents
 *
 ...
 *  </ul>
 *
 *  In fact, the message format is the same as {@link MessageType#DIRECT_CONNECTION_ACK};
 *  	only the {@link Message.Field#MSG_TYPE} field differs
 *
 *  TODO refactor
 *
 * @author fabratu
 ...
 */
public class DirectConnectionAdvertiseMessage extends DirectConnectionMessage {

    /** Create a {@link MessageType#DIRECT_CONNECTION_ADVERTISE} message.
    *
    * @param messageId
    ...
    */
    public DirectConnectionAdvertiseMessage(long messageId, InetAddress inetAddr, int port) {
        super(MessageType.DIRECT_CONNECTION_ADVERTISE, messageId);
    ...
    /**
     * Construct a {@link MessageType#DIRECT_CONNECTION_ADVERTISE} message from
     ...
     */
    public DirectConnectionAdvertiseMessage(byte[] byteArray, int offset) throws MalformedMessageException {
        super(byteArray, offset, Field.getTotalOffset());

        if (this.getType() != MessageType.DIRECT_CONNECTION_ADVERTISE) {
            throw new MalformedMessageException("Malformed " + MessageType.DIRECT_CONNECTION_ADVERTISE +
    ...
    /**
     * Fields of the {@link MessageType#DIRECT_CONNECTION_ADVERTISE} header.
     *
    ...
    /**
     * Validate an IP address read from a {@link MessageType#DIRECT_CONNECTION_ADVERTISE} message
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DirectConnectionAdvertiseMessage other = (DirectConnectionAdvertiseMessage) obj;
