	...
	public void step() {
		...
		for (i3 = start; i3 <= end; i3++)
			for (i2 = 1; i2 < n2 - 1; i2++) {
				...
				for (i1 = 1; i1 < n1 - 1; i1++) {
					r[off + i1 + n1 * (i2 + n3 * i3)] = tmp[off + i1 + n1
							* (i2 + n3 * i3)]
							- a[0]
		...
		for (i3 = start; i3 <= end; i3++)
			for (i2 = 1; i2 < n2 - 1; i2++) {
				r[off + n1 * (i2 + n2 * i3)] = r[off + n1 - 2 + n1
						* (i2 + n2 * i3)];
				r[off + n1 - 1 + n1 * (i2 + n2 * i3)] = r[uoff + 1 + n1
						* (i2 + n2 * i3)];
			}

		for (i3 = start; i3 <= end; i3++)
			for (i1 = 0; i1 < n1; i1++) {
				r[off + i1 + n1 * n2 * i3] = r[off + i1 + n1
						* (n2 - 2 + n2 * i3)];
				r[off + i1 + n1 * (n2 - 1 + n2 * i3)] = r[off + i1 + n1
						* (1 + n2 * i3)];
			}
	}
