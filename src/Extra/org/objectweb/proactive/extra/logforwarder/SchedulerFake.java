...
public class SchedulerFake {
    ...
    private java.util.Hashtable<String, Logger> loggers = 
            new java.util.Hashtable<String, Logger>();
...
//        }
        ...
        NodeSet nodes = null;
        try {
            IMCore imc = (IMCore)(ProActive.lookupActive(IMCore.class.getName(), "//localhost/IMCORE"));
            imu = imc.getUser();
...
//    }
    ...
    public void listenLog(int id, String hostname, int port) {
    	Logger.getLogger(LOGGER_PREFIX+id).addAppender(new SocketAppender(hostname,port));
//        this.loggers.get(id).addAppender(new SocketAppender(hostname,port));
    ...
    public static void main(String[] args){
        ...
        try {
            SchedulerFake sf = (SchedulerFake)(ProActive.newActive(SchedulerFake.class.getName(),null));
