...
public class ClientSocketForwarder extends SocketForwarder {
	...
	public ClientSocketForwarder(Object localID, int localPort,
	...
	public Socket getSocket(long lockTime) {
		Socket sock = null;
		try {
			if(logger.isDebugEnabled()) logger.debug("ClientSocketForwarder.getSocket() : lock until timeout or accept or abort connection.");
