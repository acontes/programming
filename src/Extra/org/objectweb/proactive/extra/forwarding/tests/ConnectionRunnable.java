...
public class ConnectionRunnable implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("ForwardingException, [connection = " + connectionID +
                "], could not connect to target number: " + targetID + ", exiting");
            running = false;
        } catch (IOException e) {
            System.out
                    .println("IOException, [connection = " + connectionID +
        ...
        while (running && i < nbMessages) {
            ...
            if (!clientSocket.isClosed()) {
                ...
                try {
                    ...
                    System.out.println("IOException, [connection = " + connectionID + ":" +
                        clientSocket.getLocalPort() + "], IOException while sending or receiving a message");
                    running = false;
                } catch (ClassNotFoundException e) { //should not occur
                    System.out.println("ClassNotFoundExcetpion, [connection = " + connectionID + ":" +
                        clientSocket.getLocalPort() + "], ClassNotFoundException while receiving message");
                    e.printStackTrace();
                    running = false;
                }
            } else {
        ...
        System.out.println("[connection = " + connectionID + ":" + clientSocket.getLocalPort() +
            "], Cleaning IO streams and Socket before exiting");
        ...
        try {
            ...
            System.out.println("IOException, connection = " + connectionID +
                " failed while closing IO streams and client Socket");
        }
    }
