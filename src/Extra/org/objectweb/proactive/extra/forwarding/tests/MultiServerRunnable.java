...
public class MultiServerRunnable implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            System.out
                    .println("IOException, while reading first message, closing this connection on server side");
            running = false;
        ...
        while (running && inputLine != null) {
            ...
            try {
                ...
                System.out
                        .println("IOException, while reading or writing in the socket, closing this connection on server side");
                running = false;
