...
public class Client {
	...
	public static void main(String[] args) {
		...
		try {
			...
			e.printStackTrace();
			System.err.println("could not initialize input or output stream for target number: " + targetID + ", exiting");
			System.exit(1);
		}
		...
		while (fromUser != null && !fromUser.equals("exit")) {
			...
			if (!clientSocket.isClosed()) {
				...
				try {
					...
					System.out.println("IOException occured while reading or writing in the clientSocket, exiting");
					fromUser = null;
				...
				System.out.println("socket to target number " + targetID + " is closed. Message: "+ fromUser + " not sent");
