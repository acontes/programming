...
public class IMNodeManagerImpl implements IMNodeManager{
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#addIMNode(org.objectweb.proactive.extra.infrastructuremanager.dataresource.IMNode)
	 */
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#addIMNodes(java.util.Collection)
	 */
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#getListAllIMNode()
	 */
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#getListBusyIMNode()
	 */
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#getListDownIMNode()
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#getListFreeIMNode()
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#getListWaitingIMNode()
	 */
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#getNbAllIMNode()
	 */
	public int getNbAllIMNode() {
		return freeNodes.size() + busyNodes.size() + downNodes.size() + waitingNodes.size();
	}

	/**
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#getNbBusyIMNode()
	 */
	public int getNbBusyIMNode() {
		return busyNodes.size();
	}

	/**
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#getNbDownIMNode()
	 */
	public int getNbDownIMNode() {
		return downNodes.size();
	}

	/**
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#getNbFreeIMNode()
	 */
	...
	/**
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#getNbWaitingIMNode()
	 */
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#getNodesByScript(org.objectweb.proactive.extra.scheduler.scripting.VerifyingScript)
	 */
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#removeIMNode(org.objectweb.proactive.extra.infrastructuremanager.dataresource.IMNode)
	 */
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#removeIMNodes(java.util.Collection)
	 */
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#setBusy(org.objectweb.proactive.extra.infrastructuremanager.dataresource.IMNode)
	 */
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#setDown(org.objectweb.proactive.extra.infrastructuremanager.dataresource.IMNode)
	 */
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#setFree(org.objectweb.proactive.extra.infrastructuremanager.dataresource.IMNode)
	 */
	...
	/**
	 * Update the node status.
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#setNotVerifyingScript(org.objectweb.proactive.extra.infrastructuremanager.dataresource.IMNode, org.objectweb.proactive.extra.scheduler.scripting.VerifyingScript)
	 */
	...
	/**
	 * Update the node status.
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#setVerifyingScript(org.objectweb.proactive.extra.infrastructuremanager.dataresource.IMNode, org.objectweb.proactive.extra.scheduler.scripting.VerifyingScript)
	 */
	 ...
	 * @see org.objectweb.proactive.extra.infrastructuremanager.dataresource.database.IMNodeManager#setWaitingForScriptResult(org.objectweb.proactive.extra.infrastructuremanager.dataresource.IMNode, org.objectweb.proactive.extra.scheduler.scripting.VerifyingScript, org.objectweb.proactive.extra.scheduler.scripting.ScriptResult)
	 */
	...
	private class WaitingHandler {
		...
		public WaitingHandler(IMNode imnode, 
				VerifyingScript script, ScriptResult<Boolean> futureResult) {
			this.imnode = imnode;
			this.script = script;
