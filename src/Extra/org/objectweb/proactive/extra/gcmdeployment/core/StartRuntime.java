...
public class StartRuntime {
    	...
    	if ("true".equals(System.getProperty("log4j.defaultInitOverride"))) {
             // configure log4j here to avoid classloading problems with
    		    ...
    		    if (log4jConfiguration != null) {
    		    	...
    		    	System.err.println("-Dlog4.defaultInitOverride is specified but -Dlog4j.configuration property is missing");
    		    	ret &= false;
    		    }
    	 }
    	 return  ret;
    ...
    private void parseOptions() {
    	...
    	options.addOption(Params.parent.toString(), Params.parent.sOpt, true, Params.parent.desc);
    	options.addOption(Params.creationProtocol.toString(), Params.creationProtocol.sOpt, true, Params.creationProtocol.desc);
    	...
    	// Print some information message
			...
			ProActiveRuntime localRuntime = RuntimeFactory.getProtocolSpecificRuntime(ProActiveConfiguration.getInstance()
			   ...
			   if (creationProtocolId != null) {
	        	localRuntime.getVMInformation().setCreationProtocolID(creationProtocolId);
	        } 
	        ...
	        if (parentURL != null) {
	            ...
	            try {
	               ...
	               localRuntime = 
	                ...
	                ProActiveRuntimeImpl.getProActiveRuntime().setParent(parentRuntime);
	               waitUntilInterupted();
    ...
    private enum Params {
    	...
    	creationProtocol("c", "Communication protocol to be used by this Runtime");
