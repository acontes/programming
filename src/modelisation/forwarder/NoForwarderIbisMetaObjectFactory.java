 ...
 */
public class NoForwarderIbisMetaObjectFactory
    extends ProActiveIbisMetaObjectFactory {
    //
    // -- PRIVATE MEMBERS -----------------------------------------------
    //
    private static final MetaObjectFactory instance = new NoForwarderIbisMetaObjectFactory();
     ...
     */
    public NoForwarderIbisMetaObjectFactory() {
        super();
    }
