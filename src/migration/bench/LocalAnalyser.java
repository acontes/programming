...
public class LocalAnalyser extends Object {
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 3) {
            System.out.println(
                "Usage: java migration.bench.LocalAnalyser //hostname/converterName fileName keyWord");
            System.exit(-1);
        }
        try {
            //First we get the reference on the converter
            Converter converter = (Converter) ProActive.lookupActive("migration.bench.Converter",
                    args[0]);
            ...
            if (COMPRESSION) {
                ...
                ObjectInputStream objectIn = new ObjectInputStream(new InflaterInputStream(
                            in));
            ...
            SearchResult finalResult = DataBase.searchInString(resultString,
                    args[2]);
