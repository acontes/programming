...
public class MobileAnalyser extends Object implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 4) {
            System.out.println(
                "Usage: java migration.bench.MobileAnalyser //homeHost/home //hostname/nodeName fileName keyWord");
            System.exit(-1);
        }
        ...
        try {
            ...
            MobileAnalyser mobileAnalyser = (MobileAnalyser) ProActive.newActive("migration.bench.MobileAnalyser",
                    null);
