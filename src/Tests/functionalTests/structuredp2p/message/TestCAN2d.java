...
public class TestCAN2d {
	...
	public void setUp() throws ActiveObjectCreationException, NodeException {
		...
		this.msg = new CANLookupMessage(new Coordinate[] {
	...
	public void testSendMessage() {
		System.out.println(((CANOverlay) this.firstPeer.getStructuredOverlay())
				.getArea());
		System.out
				.println(((CANOverlay) this.secondPeer.getStructuredOverlay())
						.getArea());
		System.out.println(((CANOverlay) this.thirdPeer.getStructuredOverlay())
				.getArea());
		System.out
				.println(((CANOverlay) this.fourthPeer.getStructuredOverlay())
						.getArea());

		// Lookup for peer which manages (11, 11)
		CANLookupResponseMessage response = (CANLookupResponseMessage) this.firstPeer
