...
public class TestVirtualNode7 extends GCMFunctionalTest {
    public TestVirtualNode7() throws FileNotFoundException {
        super(LocalHelpers.getDescriptor(TestVirtualNode7.class));
    }
