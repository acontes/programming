...
public class TestVirtualNode6 extends GCMFunctionalTest {
    public TestVirtualNode6() throws FileNotFoundException {
        super(LocalHelpers.getDescriptor(TestVirtualNode6.class));
    }
