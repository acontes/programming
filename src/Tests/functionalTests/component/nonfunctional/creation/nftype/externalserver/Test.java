...
public class Test extends ComponentTest {
    ...
    public Test() {
        super("Creation of a composite functional component with external non-functional server interface",
                "Creation of a composite functional component with external non-functional server interface");
    }
