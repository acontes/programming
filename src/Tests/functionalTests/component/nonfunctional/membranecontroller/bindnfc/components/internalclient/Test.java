 ...
 */
package functionalTests.component.nonfunctional.membranecontroller.bindnfc.components.internalclient;
...
public class Test extends ComponentTest {
    ...
    public Test() {
        super(
                "Binds the non-functional internal client interface of composite component to an inner functional component",
                "Binds the non-functional internal client interface of composite component to an inner functional component");
    }
