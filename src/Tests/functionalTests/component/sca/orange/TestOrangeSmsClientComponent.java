...
public class TestOrangeSmsClientComponent extends FunctionalTest {
    ...
    public void setUp() throws Exception {
        ...
        t = tf.createFcType(new InterfaceType[] {
                tf.createFcItfType(Constants.ATTRIBUTE_CONTROLLER, OrangeSMSClientAttributes.class.getName(),
                        false, false, false),
                tf.createFcItfType("Runner", Runner.class.getName(), false, false, false),
                tf.createFcItfType(OrangeSMSClientComponent.SERVICES_NAME, OrangeSMS.class.getName(), true,
                        false, false) });
    }

    @Test
    public void testOrangeSmsClient() throws Exception {
        Component c = gf.newFcInstance(t, "primitive", OrangeSMSClientComponent.class.getName());
        ...
        GCM.getBindingController(c).bindFc(OrangeSMSClientComponent.SERVICES_NAME,
