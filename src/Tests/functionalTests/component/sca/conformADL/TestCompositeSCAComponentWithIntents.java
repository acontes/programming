 ...
 * @author mug
 */
public class TestCompositeSCAComponentWithIntents extends SCAComponentTest {

    Component dummy;

    public TestCompositeSCAComponentWithIntents() {
    ...
    public void action() throws Exception {
        ...
        dummy = (Component) f
                .newComponent(
                        "functionalTests.component.sca.conformADL.components.composite.helloworld-wired_with_intents",
                        context);
