...
public class TestBindingControllerAnnotation extends Conformtest {
    ...
    // -------------------------------------------------------------------------
    public TestBindingControllerAnnotation() {
        super();
    }
    ...
    protected void setUpComponents() throws Exception {
        c = gf.newFcInstance(t, flatPrimitive, CAnnotations.class.getName());
        d = gf.newFcInstance(t, flatPrimitive, CAnnotations.class.getName());
        e = gf.newFcInstance(u, flatPrimitive, CAnnotations.class.getName());
    }
