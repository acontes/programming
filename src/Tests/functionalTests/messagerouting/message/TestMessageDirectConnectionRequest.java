...
public class TestMessageDirectConnectionRequest extends MessageFunctionalTest {
    ...
    public void test() {
        ...
        DirectConnectionRequestGenerator msgGen = new DirectConnectionRequestGenerator();
        try {
            ...
            Assert.fail("There is a problem in the " + MessageType.DIRECT_CONNECTION_REQUEST +
