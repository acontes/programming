...
public class TestISUniqueThread extends GCMFunctionalTestDefaultNodes {
    ...
    public void test() throws ActiveObjectCreationException, NodeException {
        ...
        ISUniqueThreadAgent a1 = (ISUniqueThreadAgent) PAActiveObject.newActive(ISUniqueThreadAgent.class
                .getName(), null, n1);
        ISUniqueThreadAgent a2 = (ISUniqueThreadAgent) PAActiveObject.newActive(ISUniqueThreadAgent.class
                .getName(), null, n2);
        ...
        // assert call 1 and 2
        for (int i = 0; i < 10; i++) {
            assert (a1res1.get(i).booleanValue() && a2res1.get(i).booleanValue() &&
                a1res2.get(i).booleanValue() && a2res2.get(i).booleanValue());
        }
