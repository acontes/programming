...
/**
 * The remote agent is started in DC mode.
 * The local agent is started with DC disabled
 ...
 */
public class TestDCRequestUnidirectionalACK extends UnitTests {

    private AgentRouterAgent infrastructure;

    @Before
    public void before() throws IOException, ProActiveException {
        infrastructure = new AgentRouterAgent(false, true);
    ...
    public void test() throws MessageRoutingException, MalformedMessageException, UnknownHostException {
        ...
        Assert.assertEquals(replyPort, AgentRouterAgent.R_DC_PORT);
