 ...
 * Time: 3:00:15 AM
 */
public class ProActiveMPIClusterComp extends ProActiveMPIClusterImpl implements ProActiveMPICluster, BindingController {
    ...
    public ProActiveMPIClusterComp(MPISpmd spmd, Integer numbOfNodes, Integer jobID, Integer maxJobID) {
