 ...
 * @since ProActive 2.2
 */
public class HalfFTManagerReplay extends FTManager {
    ...
    // message infos
    private MessageInfoReplay forSentMessage;
    ...
    public int init(AbstractBody owner) throws ProActiveException {
        ...
        logger.info(" Replay fault-tolerance is enabled for half body " + this.ownerID);
        return 0;
    }
