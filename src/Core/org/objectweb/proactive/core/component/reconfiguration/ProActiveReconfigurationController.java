...
/**
 * The reconfiguration controller allows to reconfigure a component at runtime.
 */
@PublicAPI
public interface ProActiveReconfigurationController {
	public static final String RECONFIGURATION_CONTROLLER_NAME = "reconfiguration-controller";
