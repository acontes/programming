...
public class ProActiveTypeBuilder extends FractalTypeBuilder {
    ...
    public Object createInterfaceType(final String name,
        ...
        String checkedCardinality = (cardinality == null)
            ? ProActiveTypeFactory.SINGLETON_CARDINALITY : cardinality;

        // TODO_M should use bootstrap type factory with extended createFcItfType method
        return ProActiveTypeFactoryImpl.instance()
                                       .createFcItfType(name, signature,
            client, optional, checkedCardinality);
    }
}
