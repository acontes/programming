 ...
 */
public interface ComposingVirtualNodeContainer {
    ComposingVirtualNode[] getComposingVirtualNodes();

    public void addComposingVirtualNode(ComposingVirtualNode arg);

    public void removeComposingVirtualNode(ComposingVirtualNode arg);
}
