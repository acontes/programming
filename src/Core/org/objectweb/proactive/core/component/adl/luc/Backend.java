...
{
	public Component createComponent(ComponentDescription componentDescription, Map<String, String> arguments, Object deploymentFile) throws ADLException, InstantiationException, NoSuchInterfaceException, IllegalContentException, IllegalLifeCycleException, IllegalBindingException
	{
