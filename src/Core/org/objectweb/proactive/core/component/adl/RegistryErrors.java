...
/**
 * {@link ErrorTemplate} group for the registry errors.
 *
 * @author The ProActive Team
 */
public enum RegistryErrors implements ErrorTemplate {
    /** */
    NAME_CONTROLLER_MISSING("It is not possible to register a component without a NameController controller."),

    /** */
    DUPLICATED_COMPONENT_NAME("A component with the name \"%s\" is already stored in the registry.",
            "componentName");
    ...
    private RegistryErrors(final String format, final Object... args) {
        this.id = ordinal();
        this.format = format;
