...
public enum PAProperties {
    ...
    PA_RMISSH_KNOWN_HOST("proactive.communication.rmissh.known_hosts", PAPropertiesType.STRING),
     ...
     */
    PA_RMISSH_KNOW_HOSTS("proactive.communication.rmissh.known_hosts", PAPropertiesType.STRING),
