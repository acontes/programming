...
public class ProActiveMPIComm {
    ...
    private native int sendJobNb(int jobNumber, int maxJobID);
    ...
    public void sendJobNumberAndRegister(int maxJobID) {
        sendJobNumber(this.jobID, maxJobID);
    ...
    ////////////////////////////////
    public void setMyNode(DGNode myNode) {
        this.myNode = myNode;
    }
