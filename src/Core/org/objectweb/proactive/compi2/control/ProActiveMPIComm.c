...
#include <sys/types.h>
#include <mpi.h>
#include "org_objectweb_proactive_compi2_control_ProActiveMPIComm.h"
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_org_objectweb_proactive_compi2_control_ProActiveMPIComm_initRecvQueue
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_org_objectweb_proactive_compi2_control_ProActiveMPIComm_initSendQueue
(JNIEnv *env, jobject jthis) {
	sem_lock(sem_set_id_java);
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_org_objectweb_proactive_compi2_control_ProActiveMPIComm_init
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_org_objectweb_proactive_compi2_control_ProActiveMPIComm_sendJobNb
...
//#########################################################################
//#########################################################################
JNIEXPORT jint JNICALL Java_org_objectweb_proactive_compi2_control_ProActiveMPIComm_sendRequest
...
JNIEXPORT jint JNICALL Java_org_objectweb_proactive_compi2_control_ProActiveMPIComm_proActiveSendRequest
(JNIEnv *env, jobject jthis, jobject jm_r, jbyteArray joa) {
	if (DEBUG_PROACTIVE_SIDE){
...
JNIEXPORT jbyteArray JNICALL Java_org_objectweb_proactive_compi2_control_ProActiveMPIComm_recvRequest
...
//#########################################################################
//#########################################################################
JNIEXPORT jint JNICALL Java_org_objectweb_proactive_compi2_control_ProActiveMPIComm_closeQueue
(JNIEnv * env, jobject jthis) {
	union semun semap;       /* semaphore value, for semctl().     */
...
//#########################################################################
//#########################################################################
JNIEXPORT jint JNICALL Java_org_objectweb_proactive_compi2_control_ProActiveMPIComm_closeAllQueues
(JNIEnv *env, jobject jthis) {
	int msqid1, msqid2 ;
	union semun semap;       /* semaphore value, for semctl().     */
