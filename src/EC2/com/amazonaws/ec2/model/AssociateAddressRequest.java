...
@XmlType(name = "", propOrder = { "instanceId", "publicIp" })
@XmlRootElement(name = "AssociateAddressRequest")
public class AssociateAddressRequest {

    @XmlElement(name = "InstanceId", required = true)
    protected String instanceId;
    @XmlElement(name = "PublicIp", required = true)
     ...
     * 
     */
    public AssociateAddressRequest(final String instanceId, final String publicIp) {
     ...
     *     this instance
     */
    public AssociateAddressRequest withInstanceId(String value) {
        setInstanceId(value);
        return this;
    }
     ...
     *     this instance
     */
    public AssociateAddressRequest withPublicIp(String value) {
        setPublicIp(value);
        return this;
    }
    ...
    protected String toJSONFragment() {
        ...
        if (isSetPublicIp()) {
            ...
            json.append(" : ");
            json.append(quoteJSON(getPublicIp()));
            first = false;
        }
