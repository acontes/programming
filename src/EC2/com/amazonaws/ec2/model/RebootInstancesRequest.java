...
@XmlRootElement(name = "RebootInstancesRequest")
public class RebootInstancesRequest {
     ...
     * 
     */
    public RebootInstancesRequest(final List<String> instanceId) {
     ...
     *     this instance
     */
    public RebootInstancesRequest withInstanceId(String... values) {
