...
@XmlType(name = "", propOrder = { "imageId" })
@XmlRootElement(name = "DeregisterImageRequest")
public class DeregisterImageRequest {
     ...
     * 
     */
    public DeregisterImageRequest(final String imageId) {
     ...
     *     this instance
     */
    public DeregisterImageRequest withImageId(String value) {
        setImageId(value);
        return this;
    }
