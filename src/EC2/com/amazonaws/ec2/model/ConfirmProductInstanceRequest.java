...
@XmlType(name = "", propOrder = { "productCode", "instanceId" })
@XmlRootElement(name = "ConfirmProductInstanceRequest")
public class ConfirmProductInstanceRequest {
     ...
     * 
     */
    public ConfirmProductInstanceRequest(final String productCode, final String instanceId) {
     ...
     *     this instance
     */
    public ConfirmProductInstanceRequest withProductCode(String value) {
     ...
     *     this instance
     */
    public ConfirmProductInstanceRequest withInstanceId(String value) {
        setInstanceId(value);
        return this;
    }
    ...
    protected String toJSONFragment() {
        ...
        if (isSetProductCode()) {
            ...
            json.append(" : ");
            json.append(quoteJSON(getProductCode()));
            first = false;
        }
        if (isSetInstanceId()) {
            if (!first)
