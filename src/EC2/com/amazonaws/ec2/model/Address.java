...
@XmlType(name = "Address", propOrder = { "instanceId", "publicIp" })
public class Address {
     ...
     * 
     */
    public Address(final String instanceId, final String publicIp) {
     ...
     *     this instance
     */
    public Address withInstanceId(String value) {
        setInstanceId(value);
        return this;
    }
     ...
     *     this instance
     */
    public Address withPublicIp(String value) {
        setPublicIp(value);
        return this;
    }
    ...
    protected String toXMLFragment() {
        ...
        if (isSetPublicIp()) {
            xml.append("<PublicIp>");
            xml.append(escapeXML(getPublicIp()));
            xml.append("</PublicIp>");
        }
        return xml.toString();
    }
