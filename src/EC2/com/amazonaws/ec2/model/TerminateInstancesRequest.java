 ...
 *       &lt;sequence>
 *         &lt;element name="InstanceId" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "TerminateInstancesRequest")
public class TerminateInstancesRequest {
     ...
     * 
     */
    public TerminateInstancesRequest(final List<String> instanceId) {
     ...
     *     this instance
     */
    public TerminateInstancesRequest withInstanceId(String... values) {
