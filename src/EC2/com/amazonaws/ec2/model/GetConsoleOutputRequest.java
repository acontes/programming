...
@XmlRootElement(name = "GetConsoleOutputRequest")
public class GetConsoleOutputRequest {
     ...
     * 
     */
    public GetConsoleOutputRequest(final String instanceId) {
     ...
     *     this instance
     */
    public GetConsoleOutputRequest withInstanceId(String value) {
        setInstanceId(value);
        return this;
    }
