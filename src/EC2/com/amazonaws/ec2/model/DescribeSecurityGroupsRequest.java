...
@XmlRootElement(name = "DescribeSecurityGroupsRequest")
public class DescribeSecurityGroupsRequest {
     ...
     * 
     */
    public DescribeSecurityGroupsRequest(final List<String> groupName) {
     ...
     *     this instance
     */
    public DescribeSecurityGroupsRequest withGroupName(String... values) {
