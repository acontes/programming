 ...
 *
 */
public class DescribeKeyPairsAsyncSample {

    /**
     * Just add few required parameters, and try the service
     * Describe Key Pairs functionality
     *
     * @param args unused
     */
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
         DescribeKeyPairsRequest requestOne = new DescribeKeyPairsRequest();
         // @TODO: set request parameters here

         DescribeKeyPairsRequest requestTwo = new DescribeKeyPairsRequest();
         // @TODO: set second request parameters here

         List<DescribeKeyPairsRequest> requests = new ArrayList<DescribeKeyPairsRequest>();
         requests.add(requestOne);
         requests.add(requestTwo);

         // invokeDescribeKeyPairs(service, requests);
    ...
    /**
     * Describe Key Pairs request sample
     ...
     */
    public static void invokeDescribeKeyPairs(AmazonEC2 service, List<DescribeKeyPairsRequest> requests) {
        ...
        for (DescribeKeyPairsRequest request : requests) {
            responses.add(service.describeKeyPairsAsync(request));
        }
        for (Future<DescribeKeyPairsResponse> future : responses) {
            ...
            try {
                ...
                DescribeKeyPairsRequest originalRequest = requests.get(responses.indexOf(future));
