 ...
 *
 */
public class DetachVolumeAsyncSample {
     ...
     */
    public static void invokeDetachVolume(AmazonEC2 service, List<DetachVolumeRequest> requests) {
        ...
        for (DetachVolumeRequest request : requests) {
            responses.add(service.detachVolumeAsync(request));
        }
        for (Future<DetachVolumeResponse> future : responses) {
            ...
            try {
                ...
                DetachVolumeRequest originalRequest = requests.get(responses.indexOf(future));
