...
public class ResetImageAttributeSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Reset Image Attribute 
         ***********************************************************************/
        ResetImageAttributeRequest request = new ResetImageAttributeRequest();

        // @TODO: set request parameters here

        // invokeResetImageAttribute(service, request);
    ...
    public static void invokeResetImageAttribute(AmazonEC2 service, ResetImageAttributeRequest request) {
        try {
            ...
            System.out.println("ResetImageAttribute Action Response");
            System.out
                    .println("=============================================================================");
            System.out.println();

            System.out.print("    ResetImageAttributeResponse");
            System.out.println();
