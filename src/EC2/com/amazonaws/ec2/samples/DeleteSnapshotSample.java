 ...
 *
 */
public class DeleteSnapshotSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Delete Snapshot 
         ***********************************************************************/
         DeleteSnapshotRequest request = new DeleteSnapshotRequest();
        
         // @TODO: set request parameters here

         // invokeDeleteSnapshot(service, request);
    ...
    public static void invokeDeleteSnapshot(AmazonEC2 service, DeleteSnapshotRequest request) {
        try {
            ...
            System.out.println ("DeleteSnapshot Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.print("    DeleteSnapshotResponse");
            System.out.println();
