...
/**
 *
 * Delete Key Pair  Samples
 *
 *
 */
public class DeleteKeyPairAsyncSample {

    /**
     * Just add few required parameters, and try the service
     * Delete Key Pair functionality
     *
     * @param args unused
     */
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
        DeleteKeyPairRequest requestOne = new DeleteKeyPairRequest();
        // @TODO: set request parameters here

        DeleteKeyPairRequest requestTwo = new DeleteKeyPairRequest();
        // @TODO: set second request parameters here

        List<DeleteKeyPairRequest> requests = new ArrayList<DeleteKeyPairRequest>();
        requests.add(requestOne);
        requests.add(requestTwo);

        // invokeDeleteKeyPair(service, requests);

    }

    /**
     * Delete Key Pair request sample
     * The DeleteKeyPair operation deletes a key pair.
     *   
     * @param service instance of AmazonEC2 service
     * @param requests list of requests to process
     */
    public static void invokeDeleteKeyPair(AmazonEC2 service, List<DeleteKeyPairRequest> requests) {
        ...
        for (DeleteKeyPairRequest request : requests) {
            responses.add(service.deleteKeyPairAsync(request));
        }
        for (Future<DeleteKeyPairResponse> future : responses) {
            ...
            try {
                ...
                DeleteKeyPairRequest originalRequest = requests.get(responses.indexOf(future));
