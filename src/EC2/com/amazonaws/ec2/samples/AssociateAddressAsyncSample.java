 ...
 *
 */
public class AssociateAddressAsyncSample {

    /**
     * Just add few required parameters, and try the service
     * Associate Address functionality
     *
     * @param args unused
     */
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
        AssociateAddressRequest requestOne = new AssociateAddressRequest();
        // @TODO: set request parameters here

        AssociateAddressRequest requestTwo = new AssociateAddressRequest();
        // @TODO: set second request parameters here

        List<AssociateAddressRequest> requests = new ArrayList<AssociateAddressRequest>();
        requests.add(requestOne);
        requests.add(requestTwo);

        // invokeAssociateAddress(service, requests);

    }

    /**
     * Associate Address request sample
     ...
     */
    public static void invokeAssociateAddress(AmazonEC2 service, List<AssociateAddressRequest> requests) {
        ...
        for (AssociateAddressRequest request : requests) {
            responses.add(service.associateAddressAsync(request));
        }
        for (Future<AssociateAddressResponse> future : responses) {
            ...
            try {
                ...
                AssociateAddressRequest originalRequest = requests.get(responses.indexOf(future));
