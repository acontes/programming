 ...
 *
 */
public class CreateSecurityGroupAsyncSample {
    ...
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
         CreateSecurityGroupRequest requestOne = new CreateSecurityGroupRequest();
         // @TODO: set request parameters here

         CreateSecurityGroupRequest requestTwo = new CreateSecurityGroupRequest();
         // @TODO: set second request parameters here

         List<CreateSecurityGroupRequest> requests = new ArrayList<CreateSecurityGroupRequest>();
         requests.add(requestOne);
         requests.add(requestTwo);

         // invokeCreateSecurityGroup(service, requests);
     ...
     */
    public static void invokeCreateSecurityGroup(AmazonEC2 service, List<CreateSecurityGroupRequest> requests) {
        ...
        for (CreateSecurityGroupRequest request : requests) {
            responses.add(service.createSecurityGroupAsync(request));
        }
        for (Future<CreateSecurityGroupResponse> future : responses) {
            ...
            try {
                ...
                CreateSecurityGroupRequest originalRequest = requests.get(responses.indexOf(future));
