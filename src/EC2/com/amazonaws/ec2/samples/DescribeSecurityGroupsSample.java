            ...
            if (response.isSetDescribeSecurityGroupsResult()) {
                ...
                for (SecurityGroup securityGroup : securityGroupList) {
                    ...
                    if (securityGroup.isSetOwnerId()) {
                        ...
                        System.out.println();
                        System.out.print("                    " + securityGroup.getOwnerId());
                        System.out.println();
                    }
                    if (securityGroup.isSetGroupName()) {
                        System.out.print("                GroupName");
                        System.out.println();
                        System.out.print("                    " + securityGroup.getGroupName());
                        System.out.println();
                    }
                    if (securityGroup.isSetGroupDescription()) {
                        System.out.print("                GroupDescription");
                        System.out.println();
                        System.out.print("                    " + securityGroup.getGroupDescription());
                        System.out.println();
                    }
                    java.util.List<IpPermission> ipPermissionList = securityGroup.getIpPermission();
                    for (IpPermission ipPermission : ipPermissionList) {
                        System.out.print("                IpPermission");
                        System.out.println();
                        if (ipPermission.isSetIpProtocol()) {
                            System.out.print("                    IpProtocol");
                            System.out.println();
                            System.out.print("                        " + ipPermission.getIpProtocol());
                            System.out.println();
                        }
                        if (ipPermission.isSetFromPort()) {
                            System.out.print("                    FromPort");
                            System.out.println();
                            System.out.print("                        " + ipPermission.getFromPort());
                            System.out.println();
                        }
