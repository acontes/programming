...
/**
 *
 * Delete Volume  Samples
 *
 *
 */
public class DeleteVolumeAsyncSample {

    /**
     * Just add few required parameters, and try the service
     * Delete Volume functionality
     *
     * @param args unused
     */
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
         DeleteVolumeRequest requestOne = new DeleteVolumeRequest();
         // @TODO: set request parameters here

         DeleteVolumeRequest requestTwo = new DeleteVolumeRequest();
         // @TODO: set second request parameters here

         List<DeleteVolumeRequest> requests = new ArrayList<DeleteVolumeRequest>();
         requests.add(requestOne);
         requests.add(requestTwo);

         // invokeDeleteVolume(service, requests);
     ...
     */
    public static void invokeDeleteVolume(AmazonEC2 service, List<DeleteVolumeRequest> requests) {
        ...
        for (DeleteVolumeRequest request : requests) {
            responses.add(service.deleteVolumeAsync(request));
        }
        for (Future<DeleteVolumeResponse> future : responses) {
            ...
            try {
                ...
                DeleteVolumeRequest originalRequest = requests.get(responses.indexOf(future));
