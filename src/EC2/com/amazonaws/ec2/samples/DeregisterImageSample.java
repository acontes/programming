...
public class DeregisterImageSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Deregister Image 
         ***********************************************************************/
        DeregisterImageRequest request = new DeregisterImageRequest();

        // @TODO: set request parameters here

        // invokeDeregisterImage(service, request);
    ...
    public static void invokeDeregisterImage(AmazonEC2 service, DeregisterImageRequest request) {
        try {
            ...
            System.out.println("DeregisterImage Action Response");
            System.out
                    .println("=============================================================================");
            System.out.println();

            System.out.print("    DeregisterImageResponse");
            System.out.println();
