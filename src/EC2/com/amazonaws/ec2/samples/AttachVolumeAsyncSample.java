 ...
 *
 */
public class AttachVolumeAsyncSample {

    /**
     * Just add few required parameters, and try the service
     * Attach Volume functionality
     *
     * @param args unused
     */
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
        AttachVolumeRequest requestOne = new AttachVolumeRequest();
        // @TODO: set request parameters here

        AttachVolumeRequest requestTwo = new AttachVolumeRequest();
        // @TODO: set second request parameters here

        List<AttachVolumeRequest> requests = new ArrayList<AttachVolumeRequest>();
        requests.add(requestOne);
        requests.add(requestTwo);

        // invokeAttachVolume(service, requests);

    }

    /**
     * Attach Volume request sample
     * Attach a previously created volume to a running instance.
     *   
     * @param service instance of AmazonEC2 service
     * @param requests list of requests to process
     */
    public static void invokeAttachVolume(AmazonEC2 service, List<AttachVolumeRequest> requests) {
        ...
        for (AttachVolumeRequest request : requests) {
            responses.add(service.attachVolumeAsync(request));
        }
        for (Future<AttachVolumeResponse> future : responses) {
            ...
            try {
                ...
                AttachVolumeRequest originalRequest = requests.get(responses.indexOf(future));
