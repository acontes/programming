 ...
 *
 */
public class DescribeSnapshotsAsyncSample {

    /**
     * Just add few required parameters, and try the service
     * Describe Snapshots functionality
     *
     * @param args unused
     */
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
        DescribeSnapshotsRequest requestOne = new DescribeSnapshotsRequest();
        // @TODO: set request parameters here

        DescribeSnapshotsRequest requestTwo = new DescribeSnapshotsRequest();
        // @TODO: set second request parameters here

        List<DescribeSnapshotsRequest> requests = new ArrayList<DescribeSnapshotsRequest>();
        requests.add(requestOne);
        requests.add(requestTwo);

        // invokeDescribeSnapshots(service, requests);
     ...
     */
    public static void invokeDescribeSnapshots(AmazonEC2 service, List<DescribeSnapshotsRequest> requests) {
        ...
        for (DescribeSnapshotsRequest request : requests) {
            responses.add(service.describeSnapshotsAsync(request));
        }
        for (Future<DescribeSnapshotsResponse> future : responses) {
            ...
            try {
                ...
                DescribeSnapshotsRequest originalRequest = requests.get(responses.indexOf(future));
