...
public class DeleteVolumeSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Delete Volume 
         ***********************************************************************/
        DeleteVolumeRequest request = new DeleteVolumeRequest();

        // @TODO: set request parameters here

        // invokeDeleteVolume(service, request);
     ...
     */
    public static void invokeDeleteVolume(AmazonEC2 service, DeleteVolumeRequest request) {
        try {

            DeleteVolumeResponse response = service.deleteVolume(request);

            System.out.println("DeleteVolume Action Response");
            System.out
                    .println("=============================================================================");
            System.out.println();

            System.out.print("    DeleteVolumeResponse");
            System.out.println();
