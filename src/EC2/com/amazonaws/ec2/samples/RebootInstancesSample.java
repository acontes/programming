...
public class RebootInstancesSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Reboot Instances 
         ***********************************************************************/
        RebootInstancesRequest request = new RebootInstancesRequest();

        // @TODO: set request parameters here

        // invokeRebootInstances(service, request);
    ...
    public static void invokeRebootInstances(AmazonEC2 service, RebootInstancesRequest request) {
        try {
            ...
            System.out.println("RebootInstances Action Response");
            System.out
                    .println("=============================================================================");
            System.out.println();

            System.out.print("    RebootInstancesResponse");
            System.out.println();
