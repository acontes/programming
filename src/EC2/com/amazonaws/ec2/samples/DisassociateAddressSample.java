...
public class DisassociateAddressSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Disassociate Address 
         ***********************************************************************/
         DisassociateAddressRequest request = new DisassociateAddressRequest();
        
         // @TODO: set request parameters here

         // invokeDisassociateAddress(service, request);
    ...
    public static void invokeDisassociateAddress(AmazonEC2 service, DisassociateAddressRequest request) {
        try {
            ...
            System.out.println ("DisassociateAddress Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.print("    DisassociateAddressResponse");
            System.out.println();
