 ...
 *
 */
public class DisassociateAddressAsyncSample {

    /**
     * Just add few required parameters, and try the service
     * Disassociate Address functionality
     *
     * @param args unused
     */
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
        DisassociateAddressRequest requestOne = new DisassociateAddressRequest();
        // @TODO: set request parameters here

        DisassociateAddressRequest requestTwo = new DisassociateAddressRequest();
        // @TODO: set second request parameters here

        List<DisassociateAddressRequest> requests = new ArrayList<DisassociateAddressRequest>();
        requests.add(requestOne);
        requests.add(requestTwo);

        // invokeDisassociateAddress(service, requests);

    }

    /**
     * Disassociate Address request sample
     ...
     */
    public static void invokeDisassociateAddress(AmazonEC2 service, List<DisassociateAddressRequest> requests) {
        ...
        for (DisassociateAddressRequest request : requests) {
            responses.add(service.disassociateAddressAsync(request));
        }
        for (Future<DisassociateAddressResponse> future : responses) {
            ...
            try {
                ...
                DisassociateAddressRequest originalRequest = requests.get(responses.indexOf(future));
