 ...
 *
 */
public class DescribeVolumesAsyncSample {

    /**
     * Just add few required parameters, and try the service
     * Describe Volumes functionality
     *
     * @param args unused
     */
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
        DescribeVolumesRequest requestOne = new DescribeVolumesRequest();
        // @TODO: set request parameters here

        DescribeVolumesRequest requestTwo = new DescribeVolumesRequest();
        // @TODO: set second request parameters here

        List<DescribeVolumesRequest> requests = new ArrayList<DescribeVolumesRequest>();
        requests.add(requestOne);
        requests.add(requestTwo);

        // invokeDescribeVolumes(service, requests);
     ...
     */
    public static void invokeDescribeVolumes(AmazonEC2 service, List<DescribeVolumesRequest> requests) {
        ...
        for (DescribeVolumesRequest request : requests) {
            responses.add(service.describeVolumesAsync(request));
        }
        for (Future<DescribeVolumesResponse> future : responses) {
            ...
            try {
                ...
                DescribeVolumesRequest originalRequest = requests.get(responses.indexOf(future));
