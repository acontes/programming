...
public abstract class AbstractProActiveManager extends ResourceManager {
    ...
    private AbstractProActiveManager(Node[] nodes, VirtualNode vn,
        String descriptorPath, String virtualNodeName) {
        if ((descriptorPath != null) && (virtualNodeName != null)) {
            ...
            try {
                ...
                logger.error("Error, unable to load ProActive descriptor: " +
                    descriptorPath);
                e.printStackTrace();
                return;
            }
        ...
        if (vn != null) {
            ...
            try {
                ...
                logger.error("Error, unable to get nodes from virtual node: " +
                    vn.getName());
                e.printStackTrace();
                return;
            }
    ...
    public AbstractProActiveManager(String descriptorPath,
