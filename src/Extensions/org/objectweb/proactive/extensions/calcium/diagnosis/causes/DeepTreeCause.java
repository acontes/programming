...
public class DeepTreeCause extends AbstractCause {
    @Override
    ...
    public String getDescription() {
        return "Subtasks are too fine grained, depth of subtask tree is too big.";
    }
    ...
    public String suggestAction() {
        return "Method should return true less often.";
    }
}
