...
//    	((ProActiveMPIMessage) m_r).setTimer(System.currentTimeMillis());
    ...
    protected class NativeMessagePoll implements Runnable {
        ...
        public void run() {
            ...
            System.out.println("timer_send_to_native_ipc milli " + timer_send_to_native + " moy " + ((timer_send_to_native_nb_call != 0) ? ((timer_send_to_native / timer_send_to_native_nb_call)) : 0));
