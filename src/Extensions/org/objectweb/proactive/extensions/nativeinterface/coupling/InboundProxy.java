...
public class InboundProxy implements Serializable, InitActive {
    ...
    public InboundProxy(String libName, ProActiveNativeManager manager, Integer jobNum, 
        ...
        target = new ProActiveNativeInterface(libName, PAActiveObject.getBodyOnThis().getID().hashCode(), factory);
    }

    public void initActivity(Body body) {
        this.target.setMyProxy((InboundProxy) PAActiveObject.getStubOnThis(), this.manager,
                this.jobID);
    }
...
//    }
    ...
    public void notifyProxy(Map<Integer, InboundProxy[]> jobList,
            Map<Integer, InboundProxy> groupList, OutboundProxy outboundProxy) {
        proxyMap = jobList;
