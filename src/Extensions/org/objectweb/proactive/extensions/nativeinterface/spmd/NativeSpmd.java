...
public interface NativeSpmd {
    /**
     * API method for getting Native program name
     * @return String - the name of the Native program
     */
    public String getName();

    /**
     * API method for getting nodes allocated to the NativeSpmd
     * @return allocated nodes list
     */
