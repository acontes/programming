...
public class FastSelector {
     ...
     */
    public static void findFiles(final DataSpacesFileObject fo, final FastFileSelector selector,
    ...
    private static void traverse(final Tree tree, final FileSelectInfo fileInfo,
            final FastFileSelector selector, final boolean depthwise,
            final List<DataSpacesFileObject> selected) throws Exception {
