...
// }
//
// // add 0 at the end to ease addition
...
// return (new
// LexicographicCoordinate(LexicographicCoordinate.fromUnicodeToCoordinate(middleChrCodePts)));
// }
//
// /**
...
//
// /**
// * Generates a random {@link LexicographicCoordinate}.
// *
// * @param length
// * the length of the coordinate.
// * @return the generated {@link LexicographicCoordinate}.
...
//
// LexicographicCoordinate l = new LexicographicCoordinate("abc");
...
// String min = LexicographicCoordinate.fromUnicodeToCoordinate(al);
// System.out.println("First String " + min);
// // System.out.println(al);
// LexicographicCoordinate cmin = new LexicographicCoordinate(min);
//
// ArrayList<Integer> al2 = LexicographicCoordinate.alpha2();
//
// String max = LexicographicCoordinate.fromUnicodeToCoordinate(al2);
// System.out.println("Second String " + max);
