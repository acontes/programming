...
/**
 * Defines an abstract class that all structured peer-to-peer protocols must
 * extends.
 * 
...
public abstract class StructuredOverlay implements Serializable {
	...
	/**
	 * Check neighbors list in order to see if a neighbor is died, if it is, so
	 * the list is updated.
	 */
	 ...
	 */
	public LoadBalancingResponseMessage handleLoadBalancingMessage(
