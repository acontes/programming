...
public class NeighborsArray implements Iterable<Peer> {
     ...
     *         neighbor.
     */
    public boolean add(int dimension, int direction, Peer remotePeer) {
     ...
     *         neighbor.
     */
    public boolean add(int dimension, int direction, Peer remotePeer, Area area) {
     ...
     */
    public boolean remove(int dimension, int direction, Peer remotePeer) {
     ...
     *            the direction ({@link #INFERIOR_DIRECTION} or {@link #SUPERIOR_DIRECTION}).
     */
    public void remove(int dimension, int direction) {
