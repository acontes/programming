...
public class ComponentTreeView extends ViewPart {
    ...
    private void showComponentHierachical() {
        System.out.println("[YYL Test OutPut:]" + "in ComponentTreeView " + "this.CHolder has " +
            this.CHolder.getMonitoredChildrenSize() + " children");
    ...
    private void showComponent(ComponentModel model, String parent) {
        System.out.println("[YYL Test OutPut:]" + "in ComponentTreeView " + model.getName() + " parent =" +
            parent);
    ...
    /**
     * find the exist component from the AOs in the WorldObject
     * @param w
     */
    private void findExistComponent(WorldObject w) {
