...
public class ComponentEditPart extends ComponentMonitorTreeEditPart<ComponentModel> {
    ...
    protected final void refreshVisuals() {
        ...
        if (this.getWidget() instanceof TreeItem) {
            ...
            ((TreeItem) this.getWidget()).setText(ComponentTreeView.HIERARCHICAL_COLUMN, model
                    .getHierachical());
            ((TreeItem) this.getWidget()).setText(ComponentTreeView.STATUS_COLUMN, model.getStatus());
            ((TreeItem) this.getWidget()).setText(ComponentTreeView.MEAN_ARRIVAL_RATE_COLUMN, String
                    .valueOf(model.getMeanArrivalRate()));
            ((TreeItem) this.getWidget()).setText(ComponentTreeView.MEAN_DEPARTURE_RATE_COLUMN, String
                    .valueOf(model.getMeanDepartureRate()));
            ((TreeItem) this.getWidget()).setText(ComponentTreeView.MEAN_SERVICE_RATE_COLUMN, String
                    .valueOf(model.getMeanServiceRate()));
            ((TreeItem) this.getWidget()).setText(ComponentTreeView.SAMPLE_ARRIVAL_RATE_COLUMN, String
                    .valueOf(model.getSampleArrivalRate()));
            ((TreeItem) this.getWidget()).setText(ComponentTreeView.SAMPLE_DEPARTURE_RATE_COLUMN, String
                    .valueOf(model.getSampleDepartureRate()));
            ((TreeItem) this.getWidget()).setText(ComponentTreeView.SAMPLE_SERVICE_RATE_COLUMN, String
                    .valueOf(model.getSampleServiceRate()));
            ((TreeItem) this.getWidget()).setText(ComponentTreeView.TIME_ARRIVAL_RATE_COLUMN, String
                    .valueOf(model.getTimeArrivalRate()));
            ((TreeItem) this.getWidget()).setText(ComponentTreeView.TIME_DEPARTURE_RATE_COLUMN, String
                    .valueOf(model.getTimeDepartureRate()));
            ((TreeItem) this.getWidget()).setText(ComponentTreeView.TIME_SERVICE_RATE_COLUMN, String
                    .valueOf(model.getTimeServiceRate()));
        }
    }
