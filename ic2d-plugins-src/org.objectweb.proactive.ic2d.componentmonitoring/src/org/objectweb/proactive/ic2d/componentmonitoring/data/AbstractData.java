...
public abstract class AbstractData extends Observable
{
	...
	public void removeChildFromMonitoredChildren(AbstractData child)
	{
		...
		setChanged();
		notifyObservers(new ComponentMVCNotification(ComponentMVCNotificationTag.REMOVE_CHILD_FROM_MONITORED_CHILDREN, child.getKey()));
	}
	 ...
	 */
	public Object invoke(String operationName, Object[] params, String[] signature) throws InstanceNotFoundException, MBeanException,
	...
	public Object getAttribute(String attribute) throws AttributeNotFoundException, InstanceNotFoundException, MBeanException, ReflectionException,
			IOException
	{
