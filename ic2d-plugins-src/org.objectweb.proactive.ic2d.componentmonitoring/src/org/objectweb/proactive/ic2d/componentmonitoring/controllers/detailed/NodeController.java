...
public class NodeController extends AbstractStandardToComponentsController {
    ...
    public NodeController(final AbstractData modelObject, final StandardToComponentsController parent) {
        ...
        chm = (ComponentHolderModel) this.getModelObject().getWorldObject().getHolder(
                HolderTypes.COMPONENT_HOLDER);
    ...
    private void createComponentModel(ActiveObject childModelObject) {
        ...
        for (final ObjectName oname : activeObjectNames) {
            final BodyWrapperMBean proxyBodyMBean = MBeanServerInvocationHandler.newProxyInstance(myNode
                    .getProActiveConnection(), oname, BodyWrapperMBean.class, false);
            ...
            ComponentWrapperMBean proxyComponentMBean = MBeanServerInvocationHandler.newProxyInstance(myNode
                    .getProActiveConnection(), oname, ComponentWrapperMBean.class, false);
            try {
                ComponentModel Cchild = new ComponentModel(myNode, id, activeObjectName, oname,
                    proxyComponentMBean);
                ...
                if (!chm.components.containsKey(id)) {
                    ...
                    try {
                        ...
                        JMXNotificationManager.getInstance().subscribe(Cchild.getObjectName(),
                                Cchild.getListener(),
    ...
    private void addSubComponents(ComponentModel parent, ProActiveComponent[] subcomponents,
            Map<UniqueID, ComponentModel> componentmodels) {
