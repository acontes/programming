...
public class ComponentMonitorControllerImpl extends
		AbstractComponentMonitorController {
...
//	}
	...
	{
		return new GenericTypeWrapper<String>((String)this.CompR.getMetricByName(COMPONENT_STATUS).getObject());	
	}
	
	private GenericTypeWrapper<String> getComponentHierarchicalType()
	{
		return new GenericTypeWrapper<String>((String)this.CompR.getMetricByName(COMPONENT_HIERARCHIAL_TYPE).getObject());	
	}
