...
public final class ColorPalette {
    ...
    public final static Color3f LIGHT_GRAY = new Color3f(.75f, .75f, .75f);
    public final static Color3f GRAY = new Color3f(.5f, .5f, .5f);
    public final static Color3f DARK_GRAY = new Color3f(.25f, .25f, .25f);
    public final static Color3f RED = new Color3f(1f, 0f, 0f);
    public final static Color3f PINK = new Color3f(1f, .686f, .686f);
    public final static Color3f ORANGE = new Color3f(1f, .784f, 0f);
