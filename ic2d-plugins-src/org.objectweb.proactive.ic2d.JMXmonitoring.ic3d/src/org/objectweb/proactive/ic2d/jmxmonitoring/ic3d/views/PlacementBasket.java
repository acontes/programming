...
public class PlacementBasket {
     ...
     */
    public static void xArrangement(double spacing, double padding, double height, int figureIndex,
            int figures, AbstractFigure3D figure, AbstractFigure3D parentFigure) {
    ...
    public static void yArrangement(double spacing, double padding, double height, int figureIndex,
            int figures, AbstractFigure3D figure, AbstractFigure3D parentFigure) {
        //the scale operations are relative to the 
        //GeometryBasket.FIGURE_SCALE because the object gets
        //resized automatically to the size of the parent as it is 
    ...
    public static void sphericalAOVerticalArrangement(double scale, double spacing, int figureIndex,
            int figures, AbstractFigure3D figure, AbstractFigure3D parentFigure) {
