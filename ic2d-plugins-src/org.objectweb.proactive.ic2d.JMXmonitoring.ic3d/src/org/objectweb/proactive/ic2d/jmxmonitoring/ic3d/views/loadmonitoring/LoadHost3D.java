...
public class LoadHost3D extends AbstractLoadHost3D {
	...
	public void setScale(final double loadScale) {
    	...
    	if (loadScale > LoadHost3D.LOAD_HIGH_THRESHOLD) {
            this.setAppearance(AppearanceBasket.monitorFull);
        } else if (loadScale > LoadHost3D.LOAD_AVERAGE_THRESHOLD) {
