...
public class HoverInfo extends PickMouseBehavior {
    public HoverInfo(final Canvas3D canvas, final BranchGroup root, final Bounds bounds) {
    ...
    private PickRay createPickRay(final Canvas3D canvas, final int x, final int y) {
