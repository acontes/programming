...
public abstract class AbstractFigure3D extends Shape3D implements Figure3D {
	...
	private final static Logger logger = Logger
			.getLogger(AbstractFigure3D.class.getName());
	...
	public void placeSubFigure(final Figure3D figure, final double x,
	...
	public void removeSubFigure(final Figure3D figure) {
		...
		AbstractFigure3D.logger.debug("Removing child from superbranch : "
				+ superBranch);
	 ...
	 * @param stopAO
	 */
	public void drawCommunication(final String key, final String name,
			final long timeToLive, final Figure3D startAO, final Figure3D stopAO) {
	 ...
	 * @return
	 */
	protected abstract Figure3D setArrow(String name, Vector3f start,
			Vector3f stop);
