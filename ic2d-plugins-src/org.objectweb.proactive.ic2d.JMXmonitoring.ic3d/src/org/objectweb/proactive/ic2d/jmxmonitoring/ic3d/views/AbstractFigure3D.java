...
public abstract class AbstractFigure3D extends Shape3D {
	 ...
	 * @param stopAO
	 */
	public void drawCommunication(final String key, String name,
			long timeToLive, AbstractFigure3D startAO, AbstractFigure3D stopAO) {
	 ...
	 * @return
	 */
	protected abstract AbstractFigure3D setArrow(String name, Vector3f start,
			Vector3f stop);
