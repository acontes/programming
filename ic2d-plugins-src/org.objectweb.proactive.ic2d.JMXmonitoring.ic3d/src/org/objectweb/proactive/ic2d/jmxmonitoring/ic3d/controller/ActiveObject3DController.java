...
public class ActiveObject3DController extends AbstractActiveObject3DController {
	private static final Logger logger = Logger
			.getLogger(ActiveObject3DController.class.getName());
	 ...
	 * @param parent
	 */
	public ActiveObject3DController(final AbstractData modelObject,
	...
	protected AbstractFigure3DController createChildController(
		...
		ActiveObject3DController.logger
				.debug("No children have been implemented for ActiveObjects");
	...
	public void update(final Observable o, final Object arg) {
		...
		case STATE_CHANGED: {
			...
			((ActiveObject3D) this.getFigure()).setState((State) notif
					.getData());
			// }
			// }.start();
			break;
