 ...
 */
package org.objectweb.proactive.ic2d.replay.views;
...
import org.objectweb.proactive.ic2d.replay.actions.TriggerCheckpointAction;


public class CheckpointsView extends ViewPart {

    /* The view ID */
    public static final String ID = "org.objectweb.proactive.ic2d.jmxmonitoring.view.CheckpointsView";

    /* This view is a singleton */
    private static CheckpointsView singleton;
     ...
     * @return
     */
    public static CheckpointsView getInstance() {
        if (singleton == null)
            singleton = new CheckpointsView();
        return singleton;
    }
    ...
    public void createPartControl(Composite parent) {
        ...
        TriggerCheckpointAction toolbarTrigger = new TriggerCheckpointAction(this);

        toolBarManager.add(toolbarTrigger);

        // Set a legend label
        Label legendLabel = new Label(parent, SWT.NONE);
        legendLabel.setText("This view is useless. Have a good day.");
