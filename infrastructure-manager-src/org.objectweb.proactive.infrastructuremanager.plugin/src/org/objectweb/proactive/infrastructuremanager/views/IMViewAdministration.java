	...
	public void createPartControl(Composite p) {
		...
		connectionButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				Console.getInstance().log("Connect to an existing Infrastructure Manager");
		...
		creationButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				try {
					Console.getInstance().log("Create a new Infrastructure Manager");
		...
		shutdownButton.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				Console.getInstance().warn("Shutdown an existing Infrastructure Manager");
		...
		deployButton.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				Console.getInstance().log("Load and Deploy a file descriptor");
				String viewName = viewList.getItem(viewList.getSelectionIndex());
