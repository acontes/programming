...
public class Application implements IPlatformRunnable {
	...
	private String fileName =".infrastructuremanager.java.policy";
	...
	private void searchJavaPolicyFile(){
		...
		try{
			// Seaches the '.infrastructuremanager.java.policy'
			new FileReader(file);
		}
		// If it doesn't exist
			...
			try {
				System.out.println("[IM] Creates a new file: "+file);
				// Creates an '.infrastructuremanager.java.policy' file
				...
				pw.println("permission java.lang.reflect.ReflectPermission \"suppressAccessChecks\";");
				pw.println("};");	
			}
