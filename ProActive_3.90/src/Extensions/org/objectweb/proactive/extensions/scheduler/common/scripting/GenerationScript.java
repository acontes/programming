...
public class GenerationScript extends Script<String> {
    ...
    /* (non-Javadoc)
     * @see org.objectweb.proactive.extensions.scheduler.common.scripting.Script#getEngine()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.objectweb.proactive.extensions.scheduler.common.scripting.Script#getId()
     */
    @Override
    public String getId() {
        return null;
    ...
    /* (non-Javadoc)
     * @see org.objectweb.proactive.extensions.scheduler.common.scripting.Script#getReader()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.objectweb.proactive.extensions.scheduler.common.scripting.Script#prepareBindings(javax.script.Bindings)
     */
    @Override
