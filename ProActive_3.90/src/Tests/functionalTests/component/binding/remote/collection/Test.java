...
public class Test extends ComponentTest {
    ...
    public void action() throws Exception {
        ...
        Assert.assertEquals(new Message("composite-" + PrimitiveComponentB.MESSAGE).toString(), ProActive
        ...
        //            PrimitiveComponentB.MESSAGE + PrimitiveComponentB.MESSAGE + PrimitiveComponentD.MESSAGE +
        //            Test.MESSAGE;
        // message path is: this --> D --> [B, B]
        // thus : (this+B)*2+D+this
        Assert.assertEquals(message.toString(), Test.MESSAGE + PrimitiveComponentB.MESSAGE + Test.MESSAGE +
            PrimitiveComponentB.MESSAGE + PrimitiveComponentD.MESSAGE + Test.MESSAGE);
        //        // bind the components
