...
public class ProxyForGroup extends AbstractProxy implements Proxy, Group, java.io.Serializable {
    ...
    /**
     * The list of member : it contains exclusively, StubObjects connected to
     * Proxies, or Java Objects
     */
    ...
    /**
     * Unique identificator for body (avoid infinite loop in some hierarchicals
     * groups)
     */
    ...
    public synchronized Object reify(MethodCall mc) throws InvocationTargetException {
        ...
        /*
         * result will be a stub on a proxy for group representing the group of
         * results
         */
        Object result = null;

        /*
         * check if the threadpool is big enough to make the call (is there is
         * not enough thread, create new ones)
         */
        ...
        /*
         * Special case : the method returns void but is Synchronous because it
         * throws Exception
         */
        ...
        /*
         * if the call is asynchronous the group of result will be a group a
         * future
         */
        ...
        /*
         * A barrier of synchronisation to ensure that all calls are done before
    ...
    public boolean add(Object o) {
        try {
            if ((MOP.forName(this.className)).isAssignableFrom(o.getClass())) {
                ...
                /*
                 * if o is an reified object and if it is "assignableFrom" the
                 * class of the group, ... add it into the group
                 */
    ...
    /**
     * Removes a single instance of the specified element from this Group, if it
     * is present. It removes the first occurence e where
     * <code>o.equals(e)</code> returns <code>true</code>.
     * 
     * @param o
    ...
    /**
     * Removes all this Group's elements that are also contained in the
    ...
    /**
     * Retains only the elements in this Group that are contained in the
     * specified collection. It removes from this Group all of its elements that
     * are not contained in the specified collection.
     * 
     * @param c -
     *            elements to be retained in this Group.
     * @return <code>true</code> if this Group changed as a result of the
     *         call.
     */
    ...
    /**
     * Returns an array containing all of the elements in this Group in the
     * correct order.
     * 
     * @return an array containing all of the elements in this Group in the
     *         correct order.
     */
    ...
    /**
     * Add all member of the group <code>ogroup</code> into the Group.
     * <code>ogroup</code> can be :<br> - a typed group<br> - a Group<br> -
    ...
    public void addMerge(Object oGroup) {
        try {
            ...
            /*
             * check oGroup is an Reified Object and if it is "assignableFrom"
            ...
            if ((MOP.isReifiedObject(oGroup)) &&
                 ...
                 * if oGroup is a Standard Active Object (but not a group),
                 * just add it
                 */else {
                    this.add(oGroup);
                }
     ...
     * @return the rank of <code>obj</code> in the Group. -1 if the list does
     ...
     * 
     * @return a typed group corresponding to the Group, <code>null</code> if
    ...
    // StubObject stub = MOP.createStubObject(this.className,
    ...
    /**
     * Creates a new group with all members of the group and all the members of
     * the group <code>g</code>
     * 
     * @param g -
     *            a group
     * @return a group that contain all the members of the group and
     *         <code>g</code>.
    ...
    /**
     * Creates a new group with all members that belong to the group and to the
     * group <code>g</code>.
     * 
     * @param g -
     *            a group
     * @return a group that contain the common members of the group and
     *         <code>g</code>.
     *         <code>null<code> if the class of the group is incompatible.
     */
    ...
    /**
     * Creates a new group with the members that belong to the group, but not to
     * the group <code>g</code>.
     * 
     * @param g -
     *            a group
     * @return a group that contain the members of the group without the member
     *         <code>g</code>.
     *         <code>null<code> if the class of the group is incompatible.
     */
    ...
    /**
     * Creates a new group with all members that belong to the group or to the
     * group <code>g</code>, but not to both.
     * 
     * @param g -
     *            a group
     * @return a group that contain the non-common members of the group and
     *         <code>g</code>.
     *         <code>null<code> if the class of the group is incompatible.
     */
    ...
    /**
     * Creates a new group with the members of the group begining at the index
     * <code>begin</code> and ending at the index <code>end</code>.
     * 
     * @param begin -
     *            the begining index
     * @param end -
     *            the ending index
     * @return a group that contain the members of the group from
     *         <code>begin</code> to <code>end</code>. <code>null</code>
    ...
    /**
     * Waits for one future is arrived and returns it (removes it from the
     * group).
     * 
     * @return a member of <code>o</code>. (<code>o</code> is removed from
     *         the group)
     */
     ...
     * @return the member (non-awaited) at the rank <code>n</code> in the
     *         Group.
     */
    ...
    /**
     * Returns an ExceptionListException containing all the throwables
     * (exceptions and errors) occured when this group was built
     * 
     ...
     * Exceptions (and null references) appears with
     * communication/program-level/runtime errors and are stored in the Group.
     ...
     * @param params -
     *            an array that contains the parameters for the constructor of
     *            member.
     * @param nodeList -
    ...
    /**
     * Returns <code>true</code> if this Group contains a mapping for the
     * specified key. More formally, returns <code>true</code> if and only if
     * this Group contains at a mapping for a key <code>k</code> such that
     * <code>(key==null ? k==null : key.equals(k))</code>. (There can be at
     * most one such mapping.)
     * 
     * @param key -
     *            key whose presence in this Group is to be tested.
     * @return <code>true</code> if this Group contains a mapping for the
     *         specified key.
     * @throws ClassCastException -
     *             if the key is of an inappropriate type for this Group
     *             (optional).
     * @throws NullPointerException -
     *             if the key is null and this Group does not not permit null
     *             keys (optional).
     */
    ...
    /**
     * Returns <code>true</code> if this Group maps one or more keys to the
     * specified value. More formally, returns <code>true</code> if and only
     * if this Group contains at least one mapping to a value <code>v</code>
     * such that <code>(value==null ? v==null : value.equals(v))</code>.
     * 
     * @param value -
     *            value whose presence in this map is to be tested.
     * @return <code>true</code> if this Group maps one or more keys to the
     *         specified value.
     * @throws ClassCastException -
     *             if the value is of an inappropriate type for this Collection
     *             (optional).
     * @throws NullPointerException -
     *             if the value is null and this Group does not not permit null
     *             values (optional).
     */
    ...
    /**
     * Returns the Object to which this Group maps the specified key. Returns
     * <code>null</code> if the Collection contains no mapping for this key. A
     * return value of <code>null</code> does not necessarily indicate that
     * the Collection contains no mapping for the key; it's also possible that
     * the Group explicitly maps the key to null. The containsKey operation may
     * be used to distinguish these two cases. More formally, if this Group
     * contains a mapping from a key <code>k</code> to a value <code>v</code>
     * such that <code>(key==null ? k==null : key.equals(k))</code>, then
     * this method returns <code>v</code>; otherwise it returns
     ...
     *             (optional).
     * @throws NullPointerException -
     *             key is <code>null</code> and this Group does not not permit
     *             null keys (optional).
     */
    ...
    /**
     * Associates the specified value with the specified key in this Group
     * (optional operation). If the Group previously contained a mapping for
     ...
     * <code>true</code>.)) In that case, the old value is also removed from
     * the group.
     * 
     * @param key -
     ...
     * by the Group, so changes to the Group are reflected in the set, and
     * vice-versa. If the Group is modified while an iteration over the set is
     * in progress, the results of the iteration are undefined. The set supports
     * element removal, which removes the corresponding mapping from the Group,
