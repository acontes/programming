...
echo " --- RUNNING COMPONENT-BASED 3D SLICED POISSON IN 8 MACHINES  ---"
...
XMLDESCRIPTOR=$PROACTIVE/descriptors/examples/mpi/MPI-descriptor-poisson-GCM.xml

#XMLDESCRIPTOR=$PROACTIVE/descriptors/MPI-descriptor-wrapping-poisson3d-Local.xml

$JAVACMD -Dproactive.old.parser=true -Dlog4j.configuration=file:$PROACTIVE/scripts/proactive-log4j -Dproactive.rmi.port=6099 -Djava.library.path=/home/sophia/emathias/ProActiveMPI/classes/Core/org/objectweb/proactive/compi/control/ org.objectweb.proactive.examples.mpi.proactive_poisson3d_sliced.Poisson3dSlicedWrappingComp  $XMLDESCRIPTOR 
